...
//=========  (Fri Oct 23 09:13:22 2015) by ROOT version5.34/30
   ...
   Gaussian->SetParameter(0,524.3249);
   Gaussian->SetParError(0,8.351784);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,5.408721);
   Gaussian->SetParError(1,0.01645626);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.255539);
   Gaussian->SetParError(2,0.01307812);
   Gaussian->SetParLimits(2,0,13.50236);
