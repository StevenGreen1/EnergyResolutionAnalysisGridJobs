...
//=========  (Fri Oct 23 09:13:30 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(144.9718);
   Gaussian->SetNDF(37);
   ...
   Gaussian->SetParameter(0,599.4216);
   Gaussian->SetParError(0,9.597508);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,9.388989);
   Gaussian->SetParError(1,0.02292396);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.729405);
   Gaussian->SetParError(2,0.0175049);
   Gaussian->SetParLimits(2,0,18.2179);
