...
//=========  (Fri Oct 23 09:13:12 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-6.25,-117.3375,56.25,1056.038);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,54);
   Name->SetBinContent(20,94);
   Name->SetBinContent(21,161);
   Name->SetBinContent(22,329);
   Name->SetBinContent(23,474);
   Name->SetBinContent(24,640);
   Name->SetBinContent(25,788);
   Name->SetBinContent(26,862);
   Name->SetBinContent(27,894);
   Name->SetBinContent(28,773);
   Name->SetBinContent(29,590);
   Name->SetBinContent(30,428);
   Name->SetBinContent(31,252);
   ...
   Gaussian->SetChisquare(85.70821);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,866.8227);
   Gaussian->SetParError(0,13.46472);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.86719);
   Gaussian->SetParError(1,0.03773412);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.086478);
   Gaussian->SetParError(2,0.02962923);
   Gaussian->SetParLimits(2,0,33.45798);
