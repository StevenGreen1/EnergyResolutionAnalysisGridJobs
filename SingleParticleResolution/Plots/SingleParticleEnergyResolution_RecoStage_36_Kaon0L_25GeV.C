...
//=========  (Fri Oct 23 12:31:05 2015) by ROOT version5.34/30
   ...
   Name->Range(-6.25,-126.7875,56.25,1141.088);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,62);
   Name->SetBinContent(20,98);
   Name->SetBinContent(21,194);
   Name->SetBinContent(22,301);
   Name->SetBinContent(23,462);
   Name->SetBinContent(24,714);
   Name->SetBinContent(25,809);
   Name->SetBinContent(26,966);
   Name->SetBinContent(27,889);
   Name->SetBinContent(28,770);
   Name->SetBinContent(29,592);
   Name->SetBinContent(30,357);
   Name->SetBinContent(31,225);
   Name->SetBinContent(32,112);
   Name->SetBinContent(33,48);
   ...
   Gaussian->SetParameter(0,909.7078);
   Gaussian->SetParError(0,14.32086);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.64678);
   Gaussian->SetParError(1,0.03611969);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.920236);
   Gaussian->SetParError(2,0.02885341);
   Gaussian->SetParLimits(2,0,31.95272);
