...
//=========  (Fri Oct 23 12:31:09 2015) by ROOT version5.34/30
   ...
   Name->Range(-1.75,-76.38751,15.75,687.4875);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(15,104);
   Name->SetBinContent(16,142);
   Name->SetBinContent(17,238);
   Name->SetBinContent(18,309);
   Name->SetBinContent(19,351);
   Name->SetBinContent(20,430);
   Name->SetBinContent(21,488);
   Name->SetBinContent(22,563);
   Name->SetBinContent(23,551);
   Name->SetBinContent(24,582);
   Name->SetBinContent(25,514);
   Name->SetBinContent(26,473);
   Name->SetBinContent(27,401);
   Name->SetBinContent(28,385);
   Name->SetBinContent(29,301);
   Name->SetBinContent(30,258);
   Name->SetBinContent(31,181);
   Name->SetBinContent(32,143);
   ...
   Gaussian->SetParameter(0,553.6752);
   Gaussian->SetParError(0,8.372631);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,6.57374);
   Gaussian->SetParError(1,0.01762461);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.382341);
   Gaussian->SetParError(2,0.0125745);
   Gaussian->SetParLimits(2,0,14.5023);
