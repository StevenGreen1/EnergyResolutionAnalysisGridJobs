...
//=========  (Fri Oct 23 09:13:07 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(5,11);
   Name->SetBinContent(6,12);
   Name->SetBinContent(7,16);
   Name->SetBinContent(8,15);
   Name->SetBinContent(9,26);
   ...
   Gaussian->SetChisquare(188.4142);
   Gaussian->SetNDF(46);
   ...
   Gaussian->SetParameter(0,494.9704);
   Gaussian->SetParError(0,7.552955);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,3.494819);
   Gaussian->SetParError(1,0.01159214);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.9415303);
   Gaussian->SetParError(2,0.009237768);
   Gaussian->SetParLimits(2,0,10.12531);
