...
//=========  (Fri Oct 23 15:06:00 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.8592028022);
   graph->SetPoint(1,2,1.686046004);
   graph->SetPoint(2,3,2.618180513);
   graph->SetPoint(3,4,3.563952684);
   graph->SetPoint(4,5,4.563630104);
   graph->SetPoint(5,6,5.531672478);
   graph->SetPoint(6,7,6.573740482);
   graph->SetPoint(7,8,7.586532593);
   graph->SetPoint(8,9,8.642201424);
   graph->SetPoint(9,10,9.587576866);
   graph->SetPoint(10,15,14.69502735);
   graph->SetPoint(11,20,20.26157379);
   graph->SetPoint(12,25,25.73214912);
   graph->SetPoint(13,30,30.77305222);
   graph->SetPoint(14,35,35.58560562);
   graph->SetPoint(15,40,40.3739624);
   graph->SetPoint(16,45,45.07977295);
   graph->SetPoint(17,50,49.83034134);
   
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","PFO Energy vs True Energy",100,0,55);
   Graph_Graph3->SetMinimum(0);
   Graph_Graph3->SetMaximum(55);
   Graph_Graph3->SetDirectory(0);
   Graph_Graph3->SetStats(0);
   Graph_Graph3->SetLineWidth(2);
   Graph_Graph3->SetMarkerStyle(20);
   Graph_Graph3->GetXaxis()->SetTitle("True Energy [GeV]");
   ...
   Graph_Graph3->GetYaxis()->SetTitle("PFO Energy [GeV]");
   ...
   LinearityFit->SetChisquare(1.492978);
   ...
   LinearityFit->SetParameter(0,1.007345);
   LinearityFit->SetParError(0,0.01192428);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-0.007123767);
   LinearityFit->SetParError(1,0.3894452);
