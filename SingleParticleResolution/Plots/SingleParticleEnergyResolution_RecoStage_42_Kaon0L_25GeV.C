...
//=========  (Fri Oct 23 09:13:30 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(95.37811);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,797.6055);
   Gaussian->SetParError(0,12.45619);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,26.15696);
   Gaussian->SetParError(1,0.04109341);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.350027);
   Gaussian->SetParError(2,0.03258271);
   Gaussian->SetParLimits(2,0,35.8269);
