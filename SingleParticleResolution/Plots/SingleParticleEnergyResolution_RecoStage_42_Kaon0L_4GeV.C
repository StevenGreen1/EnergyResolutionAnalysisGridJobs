...
//=========  (Fri Oct 23 09:13:28 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(206.2019);
   Gaussian->SetNDF(46);
   ...
   Gaussian->SetParError(0,7.56482);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,3.48637);
   Gaussian->SetParError(1,0.0117062);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.9433904);
   Gaussian->SetParError(2,0.009392587);
   Gaussian->SetParLimits(2,0,10.1736);
