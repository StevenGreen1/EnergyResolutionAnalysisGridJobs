...
//=========  (Fri Oct 23 09:13:18 2015) by ROOT version5.34/30
   ...
   Name->Range(-5,-104.475,45,940.275);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(21,282);
   Name->SetBinContent(22,423);
   Name->SetBinContent(23,607);
   Name->SetBinContent(24,751);
   Name->SetBinContent(25,762);
   Name->SetBinContent(26,796);
   Name->SetBinContent(27,707);
   Name->SetBinContent(28,615);
   Name->SetBinContent(29,505);
   Name->SetBinContent(30,365);
   Name->SetBinContent(31,259);
   ...
   Gaussian->SetChisquare(88.01561);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,779.7898);
   Gaussian->SetParError(0,12.12332);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,20.2443);
   Gaussian->SetParError(1,0.03376569);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.778229);
   Gaussian->SetParError(2,0.02699287);
   Gaussian->SetParLimits(2,0,29.47741);
