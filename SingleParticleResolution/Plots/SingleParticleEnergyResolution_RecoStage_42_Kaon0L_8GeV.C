...
//=========  (Fri Oct 23 09:13:29 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(201.5473);
   Gaussian->SetNDF(38);
   ...
   Gaussian->SetParameter(0,569.0843);
   Gaussian->SetParError(0,8.879367);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,7.426865);
   Gaussian->SetParError(1,0.01994826);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.494649);
   Gaussian->SetParError(2,0.01444729);
   Gaussian->SetParLimits(2,0,16.26025);
