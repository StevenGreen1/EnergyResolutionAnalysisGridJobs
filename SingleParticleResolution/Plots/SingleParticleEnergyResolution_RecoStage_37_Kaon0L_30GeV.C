...
//=========  (Fri Oct 23 12:31:11 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-130.725,67.5,1176.525);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(24,679);
   Name->SetBinContent(25,859);
   Name->SetBinContent(26,996);
   Name->SetBinContent(27,990);
   Name->SetBinContent(28,798);
   Name->SetBinContent(29,513);
   Name->SetBinContent(30,300);
   Name->SetBinContent(31,183);
   Name->SetBinContent(32,87);
   Name->SetBinContent(33,41);
   Name->SetBinContent(34,17);
   Name->SetBinContent(35,6);
   Name->SetBinContent(36,4);
   Name->SetBinContent(37,1);
   Name->SetBinContent(38,2);
   Name->SetEntries(6568);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(135.4297);
   Gaussian->SetNDF(29);
   ...
   Gaussian->SetParameter(0,949.2569);
   Gaussian->SetParError(0,15.67692);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,30.77305);
   Gaussian->SetParError(1,0.0408715);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.244092);
   Gaussian->SetParError(2,0.03512817);
   Gaussian->SetParLimits(2,0,35.723);
