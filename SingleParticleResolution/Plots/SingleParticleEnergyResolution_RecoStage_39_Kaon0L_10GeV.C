...
//=========  (Fri Oct 23 09:13:10 2015) by ROOT version5.34/30
   ...
   Name->Range(-2.5,-83.21251,22.5,748.9125);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(14,25);
   Name->SetBinContent(15,54);
   Name->SetBinContent(16,97);
   Name->SetBinContent(17,162);
   Name->SetBinContent(18,230);
   Name->SetBinContent(19,324);
   Name->SetBinContent(20,446);
   Name->SetBinContent(21,509);
   Name->SetBinContent(22,634);
   Name->SetBinContent(23,602);
   Name->SetBinContent(24,614);
   Name->SetBinContent(25,600);
   Name->SetBinContent(26,492);
   Name->SetBinContent(27,424);
   Name->SetBinContent(28,370);
   Name->SetBinContent(29,265);
   Name->SetBinContent(30,213);
   Name->SetBinContent(31,173);
   Name->SetBinContent(32,119);
   Name->SetBinContent(33,76);
   ...
   Gaussian->SetChisquare(110.8433);
   Gaussian->SetNDF(35);
   ...
   Gaussian->SetParameter(0,606.4702);
   Gaussian->SetParError(0,9.600095);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,9.395707);
   Gaussian->SetParError(1,0.0223482);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.718545);
   Gaussian->SetParError(2,0.01696946);
   Gaussian->SetParLimits(2,0,17.82284);
