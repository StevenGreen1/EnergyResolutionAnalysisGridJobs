...
//=========  (Tue Oct 20 18:46:26 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(75.82453);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,768.4803);
   Gaussian->SetParError(0,11.82571);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.71352);
   Gaussian->SetParError(1,0.04312192);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.571798);
   Gaussian->SetParError(2,0.03416697);
   Gaussian->SetParLimits(2,0,37.55382);
