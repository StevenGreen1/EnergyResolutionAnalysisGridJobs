...
//=========  (Tue Oct 20 18:45:04 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-5,-93.97501,45,845.775);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,204);
   Name->SetBinContent(20,291);
   Name->SetBinContent(21,409);
   Name->SetBinContent(22,548);
   Name->SetBinContent(23,630);
   Name->SetBinContent(24,713);
   Name->SetBinContent(25,706);
   Name->SetBinContent(26,716);
   Name->SetBinContent(27,594);
   Name->SetBinContent(28,558);
   Name->SetBinContent(29,437);
   Name->SetBinContent(30,340);
   Name->SetBinContent(31,221);
   ...
   Gaussian->SetChisquare(70.30453);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,706.9563);
   Gaussian->SetParError(0,10.70862);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.83124);
   Gaussian->SetParError(1,0.03817708);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.188601);
   Gaussian->SetParError(2,0.02990786);
   Gaussian->SetParLimits(2,0,32.91586);
