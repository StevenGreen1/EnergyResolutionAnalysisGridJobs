...
//=========  (Tue Oct 20 18:44:54 2015) by ROOT version5.34/30
   ...
   Name->Range(-1.75,-68.69541,15.75,618.2586);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(197.2355);
   Gaussian->SetNDF(44);
   ...
   Gaussian->SetParameter(0,523.5412);
   Gaussian->SetParError(0,7.873039);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,6.055672);
   Gaussian->SetParError(1,0.0195069);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.502138);
   Gaussian->SetParError(2,0.01378666);
   Gaussian->SetParLimits(2,0,15.96325);
