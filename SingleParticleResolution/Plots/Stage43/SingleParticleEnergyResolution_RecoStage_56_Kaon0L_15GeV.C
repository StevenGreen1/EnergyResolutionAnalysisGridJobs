...
//=========  (Tue Oct 20 18:45:59 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(15,43);
   Name->SetBinContent(16,56);
   Name->SetBinContent(17,116);
   Name->SetBinContent(18,183);
   Name->SetBinContent(19,289);
   Name->SetBinContent(20,428);
   Name->SetBinContent(21,588);
   Name->SetBinContent(22,753);
   Name->SetBinContent(23,739);
   Name->SetBinContent(24,719);
   Name->SetBinContent(25,664);
   Name->SetBinContent(26,562);
   Name->SetBinContent(27,550);
   Name->SetBinContent(28,395);
   Name->SetBinContent(29,321);
   Name->SetBinContent(30,226);
   Name->SetBinContent(31,164);
   ...
   Gaussian->SetChisquare(122.4749);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,717.2136);
   Gaussian->SetParError(0,11.01673);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.19825);
   Gaussian->SetParError(1,0.02882638);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.341071);
   Gaussian->SetParError(2,0.02262172);
   Gaussian->SetParLimits(2,0,24.20903);
