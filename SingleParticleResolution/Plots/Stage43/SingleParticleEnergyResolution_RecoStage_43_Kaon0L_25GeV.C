...
//=========  (Tue Oct 20 18:44:20 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(29,584);
   Name->SetBinContent(30,459);
   Name->SetBinContent(31,300);
   Name->SetBinContent(32,229);
   Name->SetBinContent(33,146);
   ...
   Gaussian->SetChisquare(95.56712);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,797.7037);
   Gaussian->SetParError(0,12.4543);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,26.15653);
   Gaussian->SetParError(1,0.04107823);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.349479);
   Gaussian->SetParError(2,0.03254638);
   Gaussian->SetParLimits(2,0,35.84732);
