...
//=========  (Tue Oct 20 18:43:39 2015) by ROOT version5.34/30
   ...
   Name->Range(-12.5,-122.7188,112.5,1104.469);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(368.5209);
   Gaussian->SetNDF(25);
   ...
   Gaussian->SetParameter(0,901.7646);
   Gaussian->SetParError(0,15.69005);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,49.83034);
   Gaussian->SetParError(1,0.07974344);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.976308);
   Gaussian->SetParError(2,0.05567814);
   Gaussian->SetParLimits(2,0,60.84974);
