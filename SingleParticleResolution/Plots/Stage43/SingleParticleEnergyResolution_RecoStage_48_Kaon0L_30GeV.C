...
//=========  (Tue Oct 20 18:44:56 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-111.9563,67.5,1007.606);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(76.69889);
   Gaussian->SetNDF(30);
   ...
   Gaussian->SetParameter(0,850.1277);
   Gaussian->SetParError(0,12.9525);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,31.00688);
   Gaussian->SetParError(1,0.04720928);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.870832);
   Gaussian->SetParError(2,0.03606357);
   Gaussian->SetParLimits(2,0,40.93779);
