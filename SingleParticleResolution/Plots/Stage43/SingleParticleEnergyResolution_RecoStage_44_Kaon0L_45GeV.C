...
//=========  (Tue Oct 20 18:44:28 2015) by ROOT version5.34/30
   ...
   Name->Range(-11.25,-121.275,101.25,1091.475);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(16,46);
   Name->SetBinContent(17,68);
   Name->SetBinContent(18,137);
   Name->SetBinContent(19,165);
   Name->SetBinContent(20,234);
   Name->SetBinContent(21,368);
   Name->SetBinContent(22,525);
   Name->SetBinContent(23,672);
   Name->SetBinContent(24,839);
   Name->SetBinContent(25,924);
   Name->SetBinContent(26,858);
   Name->SetBinContent(27,689);
   Name->SetBinContent(28,445);
   Name->SetBinContent(29,286);
   Name->SetBinContent(30,128);
   Name->SetBinContent(31,50);
   Name->SetBinContent(32,21);
   Name->SetBinContent(33,7);
   Name->SetBinContent(34,1);
   Name->SetBinContent(36,1);
   Name->SetEntries(6531);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(228.1017);
   Gaussian->SetNDF(25);
   ...
   Gaussian->SetParameter(0,876.2128);
   Gaussian->SetParError(0,14.14593);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,43.26348);
   Gaussian->SetParError(1,0.07331322);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,5.166519);
   Gaussian->SetParError(2,0.05227051);
   Gaussian->SetParLimits(2,0,57.33516);
