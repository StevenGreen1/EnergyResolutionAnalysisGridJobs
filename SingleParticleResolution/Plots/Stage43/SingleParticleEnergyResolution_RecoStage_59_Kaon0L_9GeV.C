...
//=========  (Tue Oct 20 18:46:24 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(182.1456);
   Gaussian->SetNDF(42);
   ...
   Gaussian->SetParameter(0,574.5381);
   Gaussian->SetParError(0,8.881214);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.18456);
   Gaussian->SetParError(1,0.02214331);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.685336);
   Gaussian->SetParError(2,0.01604675);
   Gaussian->SetParLimits(2,0,18.25248);
