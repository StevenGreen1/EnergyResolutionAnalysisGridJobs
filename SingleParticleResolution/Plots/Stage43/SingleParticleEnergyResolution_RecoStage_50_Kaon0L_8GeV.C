...
//=========  (Tue Oct 20 18:45:11 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(232.5119);
   Gaussian->SetNDF(40);
   ...
   Gaussian->SetParameter(0,546.3967);
   Gaussian->SetParError(0,8.296861);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,7.010671);
   Gaussian->SetParError(1,0.02136205);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.605507);
   Gaussian->SetParError(2,0.01482926);
   Gaussian->SetParLimits(2,0,17.47631);
