...
//=========  (Tue Oct 20 18:46:14 2015) by ROOT version5.34/30
   ...
   Name->Range(-1.75,-74.41876,15.75,669.7688);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(186.1605);
   Gaussian->SetNDF(43);
   ...
   Gaussian->SetParameter(0,536.716);
   Gaussian->SetParError(0,8.25562);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,6.210305);
   Gaussian->SetParError(1,0.0187225);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.43404);
   Gaussian->SetParError(2,0.01372207);
   Gaussian->SetParLimits(2,0,15.35581);
