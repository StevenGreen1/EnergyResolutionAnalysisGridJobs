...
//=========  (Tue Oct 20 18:44:03 2015) by ROOT version5.34/30
   ...
   Name->Range(-2,-80.85001,18,727.65);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(14,56);
   Name->SetBinContent(15,87);
   Name->SetBinContent(16,129);
   Name->SetBinContent(17,219);
   Name->SetBinContent(18,305);
   Name->SetBinContent(19,410);
   Name->SetBinContent(20,441);
   Name->SetBinContent(21,521);
   Name->SetBinContent(22,616);
   Name->SetBinContent(23,616);
   Name->SetBinContent(24,535);
   Name->SetBinContent(25,510);
   Name->SetBinContent(26,454);
   Name->SetBinContent(27,411);
   ...
   Gaussian->SetChisquare(200.8795);
   Gaussian->SetNDF(38);
   ...
   Gaussian->SetParameter(0,569.1872);
   Gaussian->SetParError(0,8.880899);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,7.426832);
   Gaussian->SetParError(1,0.01994336);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.494528);
   Gaussian->SetParError(2,0.01444697);
   Gaussian->SetParLimits(2,0,16.23669);
