...
//=========  (Tue Oct 20 18:44:12 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(106.1545);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,764.1258);
   Gaussian->SetParError(0,12.03324);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,20.26271);
   Gaussian->SetParError(1,0.03461564);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.828036);
   Gaussian->SetParError(2,0.02832604);
   Gaussian->SetParLimits(2,0,29.98117);
