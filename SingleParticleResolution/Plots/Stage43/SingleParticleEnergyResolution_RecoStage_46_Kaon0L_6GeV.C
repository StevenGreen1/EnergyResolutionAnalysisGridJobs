...
//=========  (Tue Oct 20 18:44:39 2015) by ROOT version5.34/30
   ...
   Name->Range(-1.5,-71.26876,13.5,641.4188);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(216.3682);
   Gaussian->SetNDF(45);
   ...
   Gaussian->SetParameter(0,504.956);
   Gaussian->SetParError(0,7.724916);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,5.114574);
   Gaussian->SetParError(1,0.01728313);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.345442);
   Gaussian->SetParError(2,0.01300144);
   Gaussian->SetParLimits(2,0,14.16621);
