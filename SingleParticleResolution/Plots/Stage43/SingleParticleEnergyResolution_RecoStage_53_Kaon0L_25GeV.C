...
//=========  (Tue Oct 20 18:45:36 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-6.25,-119.9625,56.25,1079.663);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,114);
   Name->SetBinContent(21,223);
   Name->SetBinContent(22,373);
   Name->SetBinContent(23,584);
   Name->SetBinContent(24,711);
   Name->SetBinContent(25,871);
   Name->SetBinContent(26,914);
   Name->SetBinContent(27,878);
   Name->SetBinContent(28,768);
   Name->SetBinContent(29,520);
   Name->SetBinContent(30,376);
   ...
   Gaussian->SetChisquare(90.96264);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,908.0638);
   Gaussian->SetParError(0,14.03003);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.44297);
   Gaussian->SetParError(1,0.03644058);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.013403);
   Gaussian->SetParError(2,0.02904447);
   Gaussian->SetParLimits(2,0,32.6626);
