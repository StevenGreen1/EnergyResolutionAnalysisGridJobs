...
//=========  (Tue Oct 20 18:45:51 2015) by ROOT version5.34/30
   ...
   Name->Range(-3.75,-98.56876,33.75,887.1188);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(17,119);
   Name->SetBinContent(18,183);
   Name->SetBinContent(19,289);
   Name->SetBinContent(20,438);
   Name->SetBinContent(21,605);
   Name->SetBinContent(22,740);
   Name->SetBinContent(23,751);
   Name->SetBinContent(24,741);
   Name->SetBinContent(25,660);
   Name->SetBinContent(26,574);
   Name->SetBinContent(27,545);
   Name->SetBinContent(28,397);
   Name->SetBinContent(29,313);
   Name->SetBinContent(30,224);
   ...
   Gaussian->SetChisquare(109.2002);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,729.2961);
   Gaussian->SetParError(0,11.17422);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.15378);
   Gaussian->SetParError(1,0.02819034);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.306981);
   Gaussian->SetParError(2,0.02218801);
   Gaussian->SetParLimits(2,0,23.85605);
