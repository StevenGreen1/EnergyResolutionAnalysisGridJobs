...
//=========  (Tue Oct 20 18:45:16 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(105.8331);
   Gaussian->SetNDF(41);
   ...
   Gaussian->SetParameter(0,198.163);
   Gaussian->SetParError(0,3.761836);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,0.7803786);
   Gaussian->SetParError(1,0.009290114);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.4531828);
   Gaussian->SetParError(2,0.0092161);
   Gaussian->SetParLimits(2,0,3.756978);
