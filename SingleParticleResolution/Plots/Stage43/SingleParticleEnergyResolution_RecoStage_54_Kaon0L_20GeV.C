...
//=========  (Tue Oct 20 18:45:43 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(63.40649);
   Gaussian->SetNDF(30);
   ...
   Gaussian->SetParameter(0,813.3492);
   Gaussian->SetParError(0,12.32757);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.68262);
   Gaussian->SetParError(1,0.03278544);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.72827);
   Gaussian->SetParError(2,0.02529819);
   Gaussian->SetParLimits(2,0,28.62595);
