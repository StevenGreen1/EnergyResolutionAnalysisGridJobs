...
//=========  (Tue Oct 20 18:45:44 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-133.35,67.5,1200.15);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(110.5902);
   Gaussian->SetNDF(26);
   ...
   Gaussian->SetParameter(0,962.6207);
   Gaussian->SetParError(0,15.37013);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,30.19991);
   Gaussian->SetParError(1,0.04113244);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.335835);
   Gaussian->SetParError(2,0.03439171);
   Gaussian->SetParLimits(2,0,36.18279);
