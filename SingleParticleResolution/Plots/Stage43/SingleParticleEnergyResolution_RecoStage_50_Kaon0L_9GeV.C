...
//=========  (Tue Oct 20 18:45:11 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(178.5052);
   Gaussian->SetNDF(41);
   ...
   Gaussian->SetParameter(0,558.5037);
   Gaussian->SetParError(0,8.519129);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.008552);
   Gaussian->SetParError(1,0.02296587);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.784695);
   Gaussian->SetParError(2,0.01681555);
   Gaussian->SetParLimits(2,0,19.06476);
