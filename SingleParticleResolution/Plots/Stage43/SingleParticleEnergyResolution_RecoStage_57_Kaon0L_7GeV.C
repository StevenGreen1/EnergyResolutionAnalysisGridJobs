...
//=========  (Tue Oct 20 18:46:06 2015) by ROOT version5.34/30
   ...
   Gaussian->SetParameter(0,536.6851);
   Gaussian->SetParError(0,8.254938);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,6.210474);
   Gaussian->SetParError(1,0.0187257);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.434171);
   Gaussian->SetParError(2,0.01372281);
   Gaussian->SetParLimits(2,0,15.35391);
