...
//=========  (Tue Oct 20 18:44:42 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-127.575,67.5,1148.175);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,134);
   Name->SetBinContent(21,233);
   Name->SetBinContent(22,374);
   Name->SetBinContent(23,550);
   Name->SetBinContent(24,766);
   Name->SetBinContent(25,972);
   Name->SetBinContent(26,934);
   Name->SetBinContent(27,906);
   Name->SetBinContent(28,720);
   Name->SetBinContent(29,471);
   Name->SetBinContent(30,306);
   Name->SetBinContent(31,184);
   ...
   Gaussian->SetChisquare(98.91453);
   Gaussian->SetNDF(28);
   ...
   Gaussian->SetParameter(0,925.0606);
   Gaussian->SetParError(0,14.55929);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,30.32184);
   Gaussian->SetParError(1,0.04306247);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.54495);
   Gaussian->SetParError(2,0.03580887);
   Gaussian->SetParLimits(2,0,37.94016);
