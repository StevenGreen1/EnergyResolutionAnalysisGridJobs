...
//=========  (Tue Oct 20 18:46:25 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(79.48178);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,727.3876);
   Gaussian->SetParError(0,11.25637);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.84084);
   Gaussian->SetParError(1,0.0367683);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.041095);
   Gaussian->SetParError(2,0.02969743);
   Gaussian->SetParLimits(2,0,31.59789);
