...
//=========  (Tue Oct 20 18:45:30 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.837104857);
   graph->SetPoint(1,2,1.643013477);
   graph->SetPoint(2,3,2.55602169);
   graph->SetPoint(3,4,3.477931738);
   graph->SetPoint(4,5,4.46380949);
   graph->SetPoint(5,6,5.402815819);
   graph->SetPoint(6,7,6.438033581);
   graph->SetPoint(7,8,7.418870449);
   graph->SetPoint(8,9,8.441782951);
   graph->SetPoint(9,10,9.365592003);
   graph->SetPoint(10,15,14.41193008);
   graph->SetPoint(11,20,19.73838615);
   graph->SetPoint(12,25,24.98420715);
   graph->SetPoint(13,30,29.77961922);
   graph->SetPoint(14,35,34.35356522);
   graph->SetPoint(15,40,38.88113022);
   graph->SetPoint(16,45,43.20016479);
   graph->SetPoint(17,50,47.66375732);
   
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","PFO Energy vs True Energy",100,0,55);
   Graph_Graph33->SetMinimum(0);
   Graph_Graph33->SetMaximum(55);
   Graph_Graph33->SetDirectory(0);
   Graph_Graph33->SetStats(0);
   Graph_Graph33->SetLineWidth(2);
   Graph_Graph33->SetMarkerStyle(20);
   Graph_Graph33->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph33->GetXaxis()->SetRange(1,100);
   Graph_Graph33->GetXaxis()->SetNdivisions(505);
   Graph_Graph33->GetXaxis()->SetLabelFont(132);
   Graph_Graph33->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph33->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph33->GetXaxis()->SetTitleFont(132);
   Graph_Graph33->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph33->GetYaxis()->SetLabelFont(132);
   Graph_Graph33->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph33->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph33->GetYaxis()->SetTitleFont(132);
   Graph_Graph33->GetZaxis()->SetLabelFont(132);
   Graph_Graph33->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph33->GetZaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(2.052893);
   ...
   LinearityFit->SetParameter(0,0.957374);
   LinearityFit->SetParError(0,0.01398264);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,0.4319291);
   LinearityFit->SetParError(1,0.456671);
