...
//=========  (Tue Oct 20 18:44:23 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(11,20,0.02935487777);
   graph->SetPoint(12,25,0.02088965662);
   ...
   TH1F *Graph_Graph16 = new TH1F("Graph_Graph16","Energy Resolution vs Jet Energy",100,0,55);
   Graph_Graph16->SetMinimum(0);
   Graph_Graph16->SetMaximum(0.25);
   Graph_Graph16->SetDirectory(0);
   Graph_Graph16->SetStats(0);
   Graph_Graph16->SetLineWidth(2);
   Graph_Graph16->SetMarkerStyle(20);
   Graph_Graph16->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph16->GetXaxis()->SetRange(1,100);
   Graph_Graph16->GetXaxis()->SetNdivisions(505);
   Graph_Graph16->GetXaxis()->SetLabelFont(132);
   Graph_Graph16->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph16->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph16->GetXaxis()->SetTitleFont(132);
   Graph_Graph16->GetYaxis()->SetTitle("Energy Resolution  #sigma_{Reco} / E_{Reco}");
   Graph_Graph16->GetYaxis()->SetLabelFont(132);
   Graph_Graph16->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph16->GetYaxis()->SetTitleSize(0.036);
