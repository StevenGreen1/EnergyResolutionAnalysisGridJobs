...
//=========  (Tue Oct 20 18:45:07 2015) by ROOT version5.34/30
   ...
   Name->Range(-12.5,-110.1188,112.5,991.0688);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(22,213);
   Name->SetBinContent(23,296);
   Name->SetBinContent(24,515);
   Name->SetBinContent(25,720);
   Name->SetBinContent(26,763);
   Name->SetBinContent(27,839);
   Name->SetBinContent(28,793);
   Name->SetBinContent(29,653);
   Name->SetBinContent(30,510);
   Name->SetBinContent(31,319);
   Name->SetBinContent(32,217);
   Name->SetBinContent(33,135);
   ...
   Gaussian->SetChisquare(107.9163);
   Gaussian->SetNDF(27);
   ...
   Gaussian->SetParameter(0,820.2354);
   Gaussian->SetParError(0,13.06301);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,53.02681);
   Gaussian->SetParError(1,0.07734093);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,6.108731);
   Gaussian->SetParError(2,0.05953836);
   Gaussian->SetParLimits(2,0,67.20554);
