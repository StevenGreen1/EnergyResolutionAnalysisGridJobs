...
//=========  (Tue Oct 20 18:44:21 2015) by ROOT version5.34/30
   ...
   Name->Range(-8.750001,-109.2,78.75,982.8);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(18,21);
   Name->SetBinContent(19,42);
   Name->SetBinContent(20,63);
   Name->SetBinContent(21,89);
   Name->SetBinContent(22,180);
   Name->SetBinContent(23,313);
   Name->SetBinContent(24,479);
   Name->SetBinContent(25,707);
   Name->SetBinContent(26,799);
   Name->SetBinContent(27,832);
   Name->SetBinContent(28,808);
   Name->SetBinContent(29,677);
   Name->SetBinContent(30,494);
   Name->SetBinContent(31,273);
   Name->SetBinContent(32,207);
   ...
   Gaussian->SetChisquare(133.7538);
   Gaussian->SetNDF(29);
   ...
   Gaussian->SetParameter(0,816.2034);
   Gaussian->SetParError(0,13.70197);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,37.13423);
   Gaussian->SetParError(1,0.0539223);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.230814);
   Gaussian->SetParError(2,0.04649776);
   Gaussian->SetParLimits(2,0,47.03792);
