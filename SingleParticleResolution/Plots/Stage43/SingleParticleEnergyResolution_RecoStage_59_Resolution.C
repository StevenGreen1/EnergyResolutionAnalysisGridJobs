...
//=========  (Tue Oct 20 18:46:29 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(5,6,0.1683138609);
   ...
   graph->SetPoint(11,20,0.02890179679);
   graph->SetPoint(12,25,0.02057761513);
   graph->SetPoint(13,30,0.01607453637);
   graph->SetPoint(14,35,0.01288245711);
   graph->SetPoint(15,40,0.01069822814);
   graph->SetPoint(16,45,0.009003479965);
   graph->SetPoint(17,50,0.007793302648);
   
   TH1F *Graph_Graph48 = new TH1F("Graph_Graph48","Energy Resolution vs Jet Energy",100,0,55);
   Graph_Graph48->SetMinimum(0);
   Graph_Graph48->SetMaximum(0.25);
   Graph_Graph48->SetDirectory(0);
   Graph_Graph48->SetStats(0);
   Graph_Graph48->SetLineWidth(2);
   Graph_Graph48->SetMarkerStyle(20);
   Graph_Graph48->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph48->GetXaxis()->SetRange(1,100);
   Graph_Graph48->GetXaxis()->SetNdivisions(505);
   Graph_Graph48->GetXaxis()->SetLabelFont(132);
   Graph_Graph48->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph48->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph48->GetXaxis()->SetTitleFont(132);
   Graph_Graph48->GetYaxis()->SetTitle("Energy Resolution  #sigma_{Reco} / E_{Reco}");
   Graph_Graph48->GetYaxis()->SetLabelFont(132);
   Graph_Graph48->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph48->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph48->GetYaxis()->SetTitleFont(132);
   Graph_Graph48->GetZaxis()->SetLabelFont(132);
   Graph_Graph48->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph48->GetZaxis()->SetTitleSize(0.036);
   Graph_Graph48->GetZaxis()->SetTitleFont(132);
