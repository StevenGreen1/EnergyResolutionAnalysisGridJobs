...
//=========  (Tue Oct 20 18:45:43 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-3.75,-102.9,33.75,926.1);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(16,62);
   Name->SetBinContent(17,100);
   Name->SetBinContent(18,169);
   Name->SetBinContent(19,283);
   Name->SetBinContent(20,390);
   Name->SetBinContent(21,623);
   Name->SetBinContent(22,707);
   Name->SetBinContent(23,784);
   Name->SetBinContent(24,775);
   Name->SetBinContent(25,668);
   Name->SetBinContent(26,607);
   Name->SetBinContent(27,557);
   Name->SetBinContent(28,446);
   Name->SetBinContent(29,295);
   Name->SetBinContent(30,215);
   Name->SetBinContent(31,150);
   Name->SetBinContent(32,83);
   Name->SetBinContent(33,61);
   ...
   Gaussian->SetChisquare(94.52029);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,753.2091);
   Gaussian->SetParError(0,11.44071);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.1928);
   Gaussian->SetParError(1,0.02708608);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.237752);
   Gaussian->SetParError(2,0.02107412);
   Gaussian->SetParLimits(2,0,23.09553);
