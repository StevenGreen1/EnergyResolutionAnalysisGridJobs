...
//=========  (Tue Oct 20 18:45:31 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,1.817121625);
   graph->SetPoint(1,2,0.7542622089);
   graph->SetPoint(2,3,0.4245504737);
   graph->SetPoint(3,4,0.287789017);
   graph->SetPoint(4,5,0.2080803961);
   graph->SetPoint(5,6,0.160636425);
   graph->SetPoint(6,7,0.1297786534);
   graph->SetPoint(7,8,0.108064644);
   graph->SetPoint(8,9,0.09195832908);
   graph->SetPoint(9,10,0.08122352511);
   graph->SetPoint(10,15,0.04773313925);
   graph->SetPoint(11,20,0.03189935163);
   graph->SetPoint(12,25,0.02332386747);
   graph->SetPoint(13,30,0.01840886101);
   graph->SetPoint(14,35,0.0149115799);
   graph->SetPoint(15,40,0.01224764995);
   graph->SetPoint(16,45,0.01040891092);
   graph->SetPoint(17,50,0.008806779049);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Energy Resolution vs Jet Energy",100,0,55);
   Graph_Graph34->SetMinimum(0);
   Graph_Graph34->SetMaximum(0.25);
   Graph_Graph34->SetDirectory(0);
   Graph_Graph34->SetStats(0);
   Graph_Graph34->SetLineWidth(2);
   Graph_Graph34->SetMarkerStyle(20);
   Graph_Graph34->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph34->GetXaxis()->SetRange(1,100);
   Graph_Graph34->GetXaxis()->SetNdivisions(505);
   Graph_Graph34->GetXaxis()->SetLabelFont(132);
   Graph_Graph34->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph34->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph34->GetXaxis()->SetTitleFont(132);
   Graph_Graph34->GetYaxis()->SetTitle("Energy Resolution  #sigma_{Reco} / E_{Reco}");
   Graph_Graph34->GetYaxis()->SetLabelFont(132);
   Graph_Graph34->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph34->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph34->GetYaxis()->SetTitleFont(132);
   Graph_Graph34->GetZaxis()->SetLabelFont(132);
   Graph_Graph34->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph34->GetZaxis()->SetTitleSize(0.036);
