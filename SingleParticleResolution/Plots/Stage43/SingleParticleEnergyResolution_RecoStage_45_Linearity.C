...
//=========  (Tue Oct 20 18:44:36 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.7670044899);
   graph->SetPoint(1,2,1.535742402);
   graph->SetPoint(2,3,2.395161867);
   graph->SetPoint(3,4,3.282652855);
   graph->SetPoint(4,5,4.239814281);
   graph->SetPoint(5,6,5.136899948);
   graph->SetPoint(6,7,6.155851364);
   graph->SetPoint(7,8,7.140885353);
   graph->SetPoint(8,9,8.129973412);
   graph->SetPoint(9,10,9.044219971);
   graph->SetPoint(10,15,14.23407078);
   graph->SetPoint(11,20,19.72570801);
   graph->SetPoint(12,25,25.18938446);
   graph->SetPoint(13,30,30.12848473);
   graph->SetPoint(14,35,34.89280701);
   graph->SetPoint(15,40,39.51857376);
   graph->SetPoint(16,45,44.04962158);
   graph->SetPoint(17,50,48.76975632);
   
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","PFO Energy vs True Energy",100,0,55);
   Graph_Graph19->SetMinimum(0);
   Graph_Graph19->SetMaximum(55);
   Graph_Graph19->SetDirectory(0);
   Graph_Graph19->SetStats(0);
   Graph_Graph19->SetLineWidth(2);
   Graph_Graph19->SetMarkerStyle(20);
   Graph_Graph19->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph19->GetXaxis()->SetRange(1,100);
   Graph_Graph19->GetXaxis()->SetNdivisions(505);
   Graph_Graph19->GetXaxis()->SetLabelFont(132);
   Graph_Graph19->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph19->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph19->GetXaxis()->SetTitleFont(132);
   Graph_Graph19->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph19->GetYaxis()->SetLabelFont(132);
   Graph_Graph19->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph19->GetYaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(1.997085);
   ...
   LinearityFit->SetParameter(0,0.9921265);
   LinearityFit->SetParError(0,0.01379124);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-0.2579478);
   LinearityFit->SetParError(1,0.4504202);
