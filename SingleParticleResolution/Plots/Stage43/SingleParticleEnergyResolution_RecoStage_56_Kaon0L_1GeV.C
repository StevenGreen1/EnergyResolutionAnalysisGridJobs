...
//=========  (Tue Oct 20 18:45:55 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(13,161);
   Name->SetBinContent(14,173);
   Name->SetBinContent(15,232);
   Name->SetBinContent(16,239);
   Name->SetBinContent(17,208);
   ...
   Gaussian->SetChisquare(103.8522);
   Gaussian->SetNDF(41);
   ...
   Gaussian->SetParameter(0,215.4681);
   Gaussian->SetParError(0,3.989952);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,0.8311607);
   Gaussian->SetParError(1,0.007600827);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.430311);
   Gaussian->SetParError(2,0.007730193);
   Gaussian->SetParLimits(2,0,3.704766);
