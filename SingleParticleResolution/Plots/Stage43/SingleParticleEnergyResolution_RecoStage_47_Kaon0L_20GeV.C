...
//=========  (Tue Oct 20 18:44:48 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-5,-97.91251,45,881.2125);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(18,89);
   Name->SetBinContent(19,161);
   Name->SetBinContent(20,271);
   Name->SetBinContent(21,366);
   Name->SetBinContent(22,532);
   Name->SetBinContent(23,596);
   Name->SetBinContent(24,695);
   Name->SetBinContent(25,746);
   Name->SetBinContent(26,723);
   Name->SetBinContent(27,668);
   Name->SetBinContent(28,580);
   Name->SetBinContent(29,487);
   Name->SetBinContent(30,370);
   Name->SetBinContent(31,263);
   ...
   Gaussian->SetChisquare(55.46305);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,738.0805);
   Gaussian->SetParError(0,11.01002);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.98136);
   Gaussian->SetParError(1,0.03637461);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.057473);
   Gaussian->SetParError(2,0.02754331);
   Gaussian->SetParLimits(2,0,31.72684);
