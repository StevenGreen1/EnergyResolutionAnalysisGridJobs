...
//=========  (Tue Oct 20 18:45:19 2015) by ROOT version5.34/30
   ...
   Name->Range(-2.5,-69.43126,22.5,624.8813);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(12,11);
   Name->SetBinContent(13,59);
   Name->SetBinContent(14,80);
   Name->SetBinContent(15,140);
   Name->SetBinContent(16,181);
   Name->SetBinContent(17,275);
   Name->SetBinContent(18,357);
   Name->SetBinContent(19,442);
   Name->SetBinContent(20,510);
   Name->SetBinContent(21,510);
   Name->SetBinContent(22,500);
   Name->SetBinContent(23,529);
   Name->SetBinContent(24,492);
   Name->SetBinContent(25,433);
   Name->SetBinContent(26,374);
   Name->SetBinContent(27,291);
   Name->SetBinContent(28,251);
   Name->SetBinContent(29,208);
   ...
   Gaussian->SetParameter(0,526.503);
   Gaussian->SetParError(0,8.556365);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.917281);
   Gaussian->SetParError(1,0.02596375);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.842518);
   Gaussian->SetParError(2,0.01839767);
   Gaussian->SetParLimits(2,0,19.78002);
