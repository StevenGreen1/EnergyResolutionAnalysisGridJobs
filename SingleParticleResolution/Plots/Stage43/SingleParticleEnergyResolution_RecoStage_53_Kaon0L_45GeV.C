...
//=========  (Tue Oct 20 18:45:37 2015) by ROOT version5.34/30
   ...
   Name->Range(-11.25,-124.5563,101.25,1121.006);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,120);
   Name->SetBinContent(20,174);
   Name->SetBinContent(21,258);
   Name->SetBinContent(22,419);
   Name->SetBinContent(23,536);
   Name->SetBinContent(24,795);
   Name->SetBinContent(25,918);
   Name->SetBinContent(26,949);
   Name->SetBinContent(27,817);
   Name->SetBinContent(28,526);
   Name->SetBinContent(29,355);
   Name->SetBinContent(30,171);
   Name->SetBinContent(31,78);
   Name->SetBinContent(32,28);
   Name->SetBinContent(33,7);
   Name->SetBinContent(34,4);
   Name->SetBinContent(36,1);
   Name->SetEntries(6326);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(197.2966);
   Gaussian->SetNDF(26);
   ...
   Gaussian->SetParameter(0,898.3327);
   Gaussian->SetParError(0,14.90719);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,44.39994);
   Gaussian->SetParError(1,0.06846343);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.900198);
   Gaussian->SetParError(2,0.05202116);
   Gaussian->SetParLimits(2,0,54.3096);
