...
//=========  (Tue Oct 20 18:46:07 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(201.2995);
   Gaussian->SetNDF(39);
   ...
   Gaussian->SetParameter(0,556.9182);
   Gaussian->SetParError(0,8.567643);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,7.184411);
   Gaussian->SetParError(1,0.02059312);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.555502);
   Gaussian->SetParError(2,0.0147213);
   Gaussian->SetParLimits(2,0,16.75394);
