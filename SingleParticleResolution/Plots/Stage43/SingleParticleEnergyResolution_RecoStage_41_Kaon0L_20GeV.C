...
//=========  (Tue Oct 20 18:44:05 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(22,420);
   Name->SetBinContent(23,614);
   ...
   Gaussian->SetChisquare(105.8953);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,764.7991);
   Gaussian->SetParError(0,12.03649);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,20.26073);
   Gaussian->SetParError(1,0.03457494);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.825654);
   Gaussian->SetParError(2,0.02826014);
   Gaussian->SetParLimits(2,0,29.96459);
