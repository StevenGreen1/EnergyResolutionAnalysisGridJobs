...
//=========  (Tue Oct 20 18:46:28 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(5,6,5.227389336);
   ...
   graph->SetPoint(11,20,19.8408432);
   graph->SetPoint(12,25,25.71351814);
   graph->SetPoint(13,30,31.14099121);
   graph->SetPoint(14,35,36.57569885);
   graph->SetPoint(15,40,41.82576752);
   graph->SetPoint(16,45,47.14150238);
   graph->SetPoint(17,50,52.88459015);
   
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","PFO Energy vs True Energy",100,0,55);
   Graph_Graph47->SetMinimum(0);
   Graph_Graph47->SetMaximum(55);
   Graph_Graph47->SetDirectory(0);
   Graph_Graph47->SetStats(0);
   Graph_Graph47->SetLineWidth(2);
   Graph_Graph47->SetMarkerStyle(20);
   Graph_Graph47->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph47->GetXaxis()->SetRange(1,100);
   Graph_Graph47->GetXaxis()->SetNdivisions(505);
   Graph_Graph47->GetXaxis()->SetLabelFont(132);
   Graph_Graph47->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph47->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph47->GetXaxis()->SetTitleFont(132);
   Graph_Graph47->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph47->GetYaxis()->SetLabelFont(132);
   Graph_Graph47->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph47->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph47->GetYaxis()->SetTitleFont(132);
   Graph_Graph47->GetZaxis()->SetLabelFont(132);
   Graph_Graph47->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph47->GetZaxis()->SetTitleSize(0.036);
   Graph_Graph47->GetZaxis()->SetTitleFont(132);
   ...
   LinearityFit->SetChisquare(0.3192791);
   ...
   LinearityFit->SetParameter(0,1.096348);
   LinearityFit->SetParError(0,0.005514292);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-1.95824);
   LinearityFit->SetParError(1,0.1800961);
