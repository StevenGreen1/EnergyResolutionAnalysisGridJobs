...
//=========  (Tue Oct 20 18:46:17 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(91.20324);
   Gaussian->SetNDF(31);
   ...
   Gaussian->SetParameter(0,806.7093);
   Gaussian->SetParError(0,12.86674);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,31.14099);
   Gaussian->SetParError(1,0.0487242);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.990784);
   Gaussian->SetParError(2,0.0410296);
   Gaussian->SetParLimits(2,0,42.26623);
