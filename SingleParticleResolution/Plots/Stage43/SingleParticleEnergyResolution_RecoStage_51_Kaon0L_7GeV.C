...
//=========  (Tue Oct 20 18:45:18 2015) by ROOT version5.34/30
   ...
   Name->Range(-1.75,-68.84259,15.75,619.5833);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(204.8922);
   Gaussian->SetNDF(44);
   ...
   Gaussian->SetParameter(0,524.5508);
   Gaussian->SetParError(0,7.945131);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,6.037496);
   Gaussian->SetParError(1,0.01958317);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.497381);
   Gaussian->SetParError(2,0.01399122);
   Gaussian->SetParLimits(2,0,15.99641);
