...
//=========  (Tue Oct 20 18:44:02 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(158.7295);
   Gaussian->SetNDF(45);
   ...
   Gaussian->SetParameter(0,429.666);
   Gaussian->SetParError(0,6.530342);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,2.571895);
   Gaussian->SetParError(1,0.009966312);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.8176143);
   Gaussian->SetParError(2,0.008085582);
   Gaussian->SetParLimits(2,0,8.596455);
