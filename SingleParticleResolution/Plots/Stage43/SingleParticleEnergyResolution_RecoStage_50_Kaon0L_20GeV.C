...
//=========  (Tue Oct 20 18:45:12 2015) by ROOT version5.34/30
   ...
   Gaussian->SetParameter(0,706.5313);
   Gaussian->SetParError(0,10.69767);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.83305);
   Gaussian->SetParError(1,0.03820114);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.190521);
   Gaussian->SetParError(2,0.02989312);
   Gaussian->SetParLimits(2,0,32.92931);
