...
//=========  (Tue Oct 20 18:46:00 2015) by ROOT version5.34/30
   ...
   Name->Range(-8.750001,-125.6063,78.75,1130.456);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(22,245);
   Name->SetBinContent(23,440);
   Name->SetBinContent(24,613);
   Name->SetBinContent(25,793);
   Name->SetBinContent(26,872);
   Name->SetBinContent(27,957);
   Name->SetBinContent(28,750);
   Name->SetBinContent(29,597);
   Name->SetBinContent(30,422);
   Name->SetBinContent(31,218);
   ...
   Gaussian->SetChisquare(132.6692);
   Gaussian->SetNDF(30);
   ...
   Gaussian->SetParameter(0,894.2356);
   Gaussian->SetParError(0,14.20559);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,36.183);
   Gaussian->SetParError(1,0.05096747);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.002674);
   Gaussian->SetParError(2,0.03930081);
   Gaussian->SetParLimits(2,0,45.01633);
