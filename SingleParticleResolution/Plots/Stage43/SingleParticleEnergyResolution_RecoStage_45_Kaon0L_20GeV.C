...
//=========  (Tue Oct 20 18:44:34 2015) by ROOT version5.34/30
   ...
   Name->Range(-5,-110.1188,45,991.0688);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(17,46);
   Name->SetBinContent(18,76);
   Name->SetBinContent(19,171);
   Name->SetBinContent(20,269);
   Name->SetBinContent(21,402);
   Name->SetBinContent(22,499);
   Name->SetBinContent(23,677);
   Name->SetBinContent(24,778);
   Name->SetBinContent(25,839);
   Name->SetBinContent(26,781);
   Name->SetBinContent(27,770);
   Name->SetBinContent(28,545);
   Name->SetBinContent(29,450);
   Name->SetBinContent(30,307);
   Name->SetBinContent(31,203);
   Name->SetBinContent(32,108);
   Name->SetBinContent(33,64);
   Name->SetBinContent(34,32);
   Name->SetBinContent(35,6);
   Name->SetBinContent(36,7);
   Name->SetBinContent(37,8);
   Name->SetBinContent(38,2);
   Name->SetEntries(7140);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(73.24522);
   Gaussian->SetNDF(30);
   ...
   Gaussian->SetParameter(0,821.4265);
   Gaussian->SetParError(0,12.16209);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.72571);
   Gaussian->SetParError(1,0.03281271);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.74582);
   Gaussian->SetParError(2,0.02422108);
   Gaussian->SetParLimits(2,0,28.84916);
