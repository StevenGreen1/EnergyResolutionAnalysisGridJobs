...
//=========  (Tue Oct 20 18:45:45 2015) by ROOT version5.34/30
   ...
   Name->Range(-11.25,-134.5313,101.25,1210.781);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(154.6517);
   Gaussian->SetNDF(26);
   ...
   Gaussian->SetParameter(0,960.6018);
   Gaussian->SetParError(0,15.77865);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,44.35669);
   Gaussian->SetParError(1,0.06163031);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.622077);
   Gaussian->SetParError(2,0.0480995);
   Gaussian->SetParLimits(2,0,51.6184);
