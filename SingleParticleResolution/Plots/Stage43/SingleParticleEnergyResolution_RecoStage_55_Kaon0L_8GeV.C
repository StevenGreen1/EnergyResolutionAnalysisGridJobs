...
//=========  (Tue Oct 20 18:45:50 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(13,62);
   Name->SetBinContent(14,83);
   Name->SetBinContent(15,144);
   Name->SetBinContent(16,209);
   Name->SetBinContent(17,290);
   Name->SetBinContent(18,428);
   Name->SetBinContent(19,454);
   Name->SetBinContent(20,530);
   Name->SetBinContent(21,541);
   Name->SetBinContent(22,591);
   Name->SetBinContent(23,561);
   Name->SetBinContent(24,516);
   Name->SetBinContent(25,439);
   Name->SetBinContent(26,418);
   Name->SetBinContent(27,359);
   Name->SetBinContent(28,305);
   ...
   Gaussian->SetChisquare(187.9361);
   Gaussian->SetNDF(39);
   ...
   Gaussian->SetParameter(0,562.8341);
   Gaussian->SetParError(0,8.629542);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,7.182428);
   Gaussian->SetParError(1,0.02024437);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.542608);
   Gaussian->SetParError(2,0.0144941);
   Gaussian->SetParLimits(2,0,16.47552);
