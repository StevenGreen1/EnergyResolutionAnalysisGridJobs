...
//=========  (Tue Oct 20 18:45:34 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(13,23);
   Name->SetBinContent(14,46);
   Name->SetBinContent(15,86);
   Name->SetBinContent(16,130);
   Name->SetBinContent(17,176);
   Name->SetBinContent(18,248);
   Name->SetBinContent(19,333);
   Name->SetBinContent(20,398);
   Name->SetBinContent(21,443);
   Name->SetBinContent(22,502);
   Name->SetBinContent(23,573);
   Name->SetBinContent(24,486);
   Name->SetBinContent(25,500);
   Name->SetBinContent(26,493);
   Name->SetBinContent(27,389);
   Name->SetBinContent(28,326);
   Name->SetBinContent(29,262);
   Name->SetBinContent(30,231);
   Name->SetBinContent(31,134);
   ...
   Gaussian->SetChisquare(108.0673);
   Gaussian->SetNDF(39);
   ...
   Gaussian->SetParameter(0,524.7816);
   Gaussian->SetParError(0,8.477546);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.430498);
   Gaussian->SetParError(1,0.02229398);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.677936);
   Gaussian->SetParError(2,0.01660512);
   Gaussian->SetParLimits(2,0,17.67192);
