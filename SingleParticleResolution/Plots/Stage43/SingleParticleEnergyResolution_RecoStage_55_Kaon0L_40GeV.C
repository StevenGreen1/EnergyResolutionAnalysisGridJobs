...
//=========  (Tue Oct 20 18:45:53 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-139.9125,90,1259.213);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,103);
   Name->SetBinContent(21,185);
   Name->SetBinContent(22,289);
   Name->SetBinContent(23,492);
   Name->SetBinContent(24,699);
   Name->SetBinContent(25,954);
   Name->SetBinContent(26,1066);
   Name->SetBinContent(27,905);
   Name->SetBinContent(28,703);
   Name->SetBinContent(29,485);
   Name->SetBinContent(30,261);
   Name->SetBinContent(31,106);
   Name->SetBinContent(32,48);
   ...
   Gaussian->SetChisquare(160.3873);
   Gaussian->SetNDF(31);
   ...
   Gaussian->SetParameter(0,979.7419);
   Gaussian->SetParError(0,15.99591);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,40.51612);
   Gaussian->SetParError(1,0.05342748);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.138118);
   Gaussian->SetParError(2,0.04321923);
   Gaussian->SetParLimits(2,0,48.04396);
