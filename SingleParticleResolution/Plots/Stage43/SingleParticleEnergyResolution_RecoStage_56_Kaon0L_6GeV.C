...
//=========  (Tue Oct 20 18:45:57 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(20,546);
   Name->SetBinContent(21,529);
   Name->SetBinContent(22,495);
   Name->SetBinContent(23,519);
   Name->SetBinContent(24,486);
   Name->SetBinContent(25,412);
   Name->SetBinContent(26,360);
   Name->SetBinContent(27,314);
   Name->SetBinContent(28,271);
   Name->SetBinContent(29,224);
   Name->SetBinContent(30,167);
   ...
   Gaussian->SetChisquare(206.4846);
   Gaussian->SetNDF(43);
   ...
   Gaussian->SetParameter(0,520.3097);
   Gaussian->SetParError(0,8.036245);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,5.2343);
   Gaussian->SetParError(1,0.01681083);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.292309);
   Gaussian->SetParError(2,0.0126922);
   Gaussian->SetParLimits(2,0,13.78552);
