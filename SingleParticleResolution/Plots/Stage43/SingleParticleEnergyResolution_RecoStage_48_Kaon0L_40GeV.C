...
//=========  (Tue Oct 20 18:44:57 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-122.0625,90,1098.563);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(21,179);
   Name->SetBinContent(22,263);
   Name->SetBinContent(23,408);
   Name->SetBinContent(24,634);
   Name->SetBinContent(25,821);
   Name->SetBinContent(26,930);
   Name->SetBinContent(27,914);
   Name->SetBinContent(28,818);
   Name->SetBinContent(29,597);
   Name->SetBinContent(30,402);
   Name->SetBinContent(31,234);
   ...
   Gaussian->SetChisquare(136.3157);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,914.9914);
   Gaussian->SetParError(0,14.54861);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,41.29811);
   Gaussian->SetParError(1,0.05768097);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.553791);
   Gaussian->SetParError(2,0.045446);
   Gaussian->SetParLimits(2,0,51.74993);
