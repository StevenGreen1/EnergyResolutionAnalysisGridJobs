...
//=========  (Tue Oct 20 18:46:06 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(220.6166);
   Gaussian->SetNDF(43);
   ...
   Gaussian->SetParameter(0,519.5069);
   Gaussian->SetParError(0,8.046766);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,5.227419);
   Gaussian->SetParError(1,0.01689787);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.291705);
   Gaussian->SetParError(2,0.01275722);
   Gaussian->SetParLimits(2,0,13.88121);
