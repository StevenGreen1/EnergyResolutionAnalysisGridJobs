...
//=========  (Tue Oct 20 18:44:15 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(118.2989);
   Gaussian->SetNDF(41);
   ...
   Gaussian->SetParameter(0,224.1711);
   Gaussian->SetParError(0,4.15973);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,0.8610106);
   Gaussian->SetParError(1,0.006835118);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.417636);
   Gaussian->SetParError(2,0.007200587);
   Gaussian->SetParLimits(2,0,3.690231);
