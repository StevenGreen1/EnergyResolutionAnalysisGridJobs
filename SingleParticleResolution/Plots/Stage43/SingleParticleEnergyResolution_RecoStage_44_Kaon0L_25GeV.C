...
//=========  (Tue Oct 20 18:44:27 2015) by ROOT version5.34/30
   ...
   Name->Range(-6.25,-120.75,56.25,1086.75);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,94);
   Name->SetBinContent(20,185);
   Name->SetBinContent(21,292);
   Name->SetBinContent(22,492);
   Name->SetBinContent(23,622);
   Name->SetBinContent(24,810);
   Name->SetBinContent(25,890);
   Name->SetBinContent(26,920);
   Name->SetBinContent(27,807);
   Name->SetBinContent(28,692);
   ...
   Gaussian->SetChisquare(73.84941);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,902.2567);
   Gaussian->SetParError(0,13.69771);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,24.99692);
   Gaussian->SetParError(1,0.03695964);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.086355);
   Gaussian->SetParError(2,0.02882124);
   Gaussian->SetParLimits(2,0,32.98462);
