...
//=========  (Tue Oct 20 18:44:41 2015) by ROOT version5.34/30
   ...
   Name->Range(-6.25,-115.2375,56.25,1037.138);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,83);
   Name->SetBinContent(20,172);
   Name->SetBinContent(21,305);
   Name->SetBinContent(22,418);
   Name->SetBinContent(23,585);
   Name->SetBinContent(24,720);
   Name->SetBinContent(25,878);
   Name->SetBinContent(26,824);
   Name->SetBinContent(27,797);
   Name->SetBinContent(28,707);
   Name->SetBinContent(29,544);
   Name->SetBinContent(30,358);
   ...
   Gaussian->SetChisquare(74.41995);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,852.5055);
   Gaussian->SetParError(0,12.8916);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.2815);
   Gaussian->SetParError(1,0.03909192);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.257773);
   Gaussian->SetParError(2,0.03003643);
   Gaussian->SetParLimits(2,0,34.73205);
