...
//=========  (Tue Oct 20 18:45:45 2015) by ROOT version5.34/30
   ...
   Name->Range(-12.5,-127.575,112.5,1148.175);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,82);
   Name->SetBinContent(20,142);
   Name->SetBinContent(21,254);
   Name->SetBinContent(22,412);
   Name->SetBinContent(23,606);
   Name->SetBinContent(24,851);
   Name->SetBinContent(25,972);
   Name->SetBinContent(26,956);
   Name->SetBinContent(27,786);
   Name->SetBinContent(28,533);
   Name->SetBinContent(29,292);
   Name->SetBinContent(30,129);
   Name->SetBinContent(31,45);
   Name->SetBinContent(32,15);
   ...
   Gaussian->SetChisquare(186.7017);
   Gaussian->SetNDF(26);
   ...
   Gaussian->SetParameter(0,959.6687);
   Gaussian->SetParError(0,15.84043);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,49.17593);
   Gaussian->SetParError(1,0.06890235);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,5.054048);
   Gaussian->SetParError(2,0.05255872);
   Gaussian->SetParLimits(2,0,58.39562);
