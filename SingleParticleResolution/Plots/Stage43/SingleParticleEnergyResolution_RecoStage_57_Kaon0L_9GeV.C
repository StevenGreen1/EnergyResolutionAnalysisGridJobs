...
//=========  (Tue Oct 20 18:46:07 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-2.25,-81.37501,20.25,732.375);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(13,50);
   Name->SetBinContent(14,79);
   Name->SetBinContent(15,124);
   Name->SetBinContent(16,185);
   Name->SetBinContent(17,267);
   Name->SetBinContent(18,351);
   Name->SetBinContent(19,442);
   Name->SetBinContent(20,470);
   Name->SetBinContent(21,550);
   Name->SetBinContent(22,551);
   Name->SetBinContent(23,620);
   Name->SetBinContent(24,544);
   Name->SetBinContent(25,523);
   Name->SetBinContent(26,452);
   Name->SetBinContent(27,356);
   Name->SetBinContent(28,309);
   ...
   Gaussian->SetChisquare(181.6407);
   Gaussian->SetNDF(41);
   ...
   Gaussian->SetParameter(0,574.4151);
   Gaussian->SetParError(0,8.882391);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.185115);
   Gaussian->SetParError(1,0.02216314);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.685812);
   Gaussian->SetParError(2,0.01606702);
   Gaussian->SetParLimits(2,0,18.22007);
