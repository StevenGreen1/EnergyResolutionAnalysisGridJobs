...
//=========  (Tue Oct 20 18:44:05 2015) by ROOT version5.34/30
   ...
   Name->Range(-6.25,-112.2188,56.25,1009.969);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,50);
   Name->SetBinContent(20,87);
   Name->SetBinContent(21,166);
   Name->SetBinContent(22,317);
   Name->SetBinContent(23,460);
   Name->SetBinContent(24,600);
   Name->SetBinContent(25,708);
   Name->SetBinContent(26,819);
   Name->SetBinContent(27,855);
   Name->SetBinContent(28,730);
   Name->SetBinContent(29,585);
   Name->SetBinContent(30,459);
   Name->SetBinContent(31,299);
   Name->SetBinContent(32,230);
   Name->SetBinContent(33,147);
   ...
   Gaussian->SetChisquare(94.33457);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,798.2326);
   Gaussian->SetParError(0,12.44482);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,26.15661);
   Gaussian->SetParError(1,0.04105475);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.348416);
   Gaussian->SetParError(2,0.03243215);
   Gaussian->SetParLimits(2,0,35.78853);
