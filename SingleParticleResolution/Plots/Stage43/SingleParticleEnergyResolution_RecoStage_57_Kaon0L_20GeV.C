...
//=========  (Tue Oct 20 18:46:08 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(25,739);
   Name->SetBinContent(26,732);
   Name->SetBinContent(27,605);
   Name->SetBinContent(28,571);
   ...
   Gaussian->SetChisquare(78.62851);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,728.1417);
   Gaussian->SetParError(0,11.26113);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.83974);
   Gaussian->SetParError(1,0.0367242);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.038756);
   Gaussian->SetParError(2,0.02963447);
   Gaussian->SetParLimits(2,0,31.56907);
