...
//=========  (Tue Oct 20 18:45:35 2015) by ROOT version5.34/30
   ...
   Name->Range(-2.5,-83.08126,22.5,747.7313);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(14,35);
   Name->SetBinContent(15,64);
   Name->SetBinContent(16,113);
   Name->SetBinContent(17,194);
   Name->SetBinContent(18,268);
   Name->SetBinContent(19,327);
   Name->SetBinContent(20,449);
   Name->SetBinContent(21,535);
   Name->SetBinContent(22,551);
   Name->SetBinContent(23,633);
   Name->SetBinContent(24,597);
   Name->SetBinContent(25,571);
   ...
   Gaussian->SetChisquare(100.5573);
   Gaussian->SetNDF(36);
   ...
   Gaussian->SetParameter(0,601.4243);
   Gaussian->SetParError(0,9.265424);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,9.369959);
   Gaussian->SetParError(1,0.02249792);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.756108);
   Gaussian->SetParError(2,0.01630972);
   Gaussian->SetParLimits(2,0,18.14605);
