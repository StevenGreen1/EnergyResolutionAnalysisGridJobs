...
//=========  (Tue Oct 20 18:46:00 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-7.500001,-117.7313,67.5,1059.581);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,117);
   Name->SetBinContent(21,178);
   Name->SetBinContent(22,318);
   Name->SetBinContent(23,458);
   Name->SetBinContent(24,638);
   Name->SetBinContent(25,811);
   Name->SetBinContent(26,878);
   Name->SetBinContent(27,897);
   Name->SetBinContent(28,767);
   Name->SetBinContent(29,609);
   Name->SetBinContent(30,411);
   Name->SetBinContent(31,274);
   Name->SetBinContent(32,142);
   ...
   Gaussian->SetChisquare(80.87851);
   Gaussian->SetNDF(29);
   ...
   Gaussian->SetParameter(0,873.0352);
   Gaussian->SetParError(0,13.55525);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,30.96395);
   Gaussian->SetParError(1,0.04539603);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.69305);
   Gaussian->SetParError(2,0.0355772);
   Gaussian->SetParLimits(2,0,39.51481);
