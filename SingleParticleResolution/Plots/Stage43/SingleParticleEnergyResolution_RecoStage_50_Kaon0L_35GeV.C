...
//=========  (Tue Oct 20 18:45:13 2015) by ROOT version5.34/30
   ...
   Name->Range(-8.750001,-110.1188,78.75,991.0688);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(27,839);
   Name->SetBinContent(28,699);
   Name->SetBinContent(29,629);
   Name->SetBinContent(30,436);
   Name->SetBinContent(31,323);
   Name->SetBinContent(32,219);
   ...
   Gaussian->SetChisquare(104.8026);
   Gaussian->SetNDF(31);
   ...
   Gaussian->SetParameter(0,772.332);
   Gaussian->SetParError(0,12.39861);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,36.63676);
   Gaussian->SetParError(1,0.0587878);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.771202);
   Gaussian->SetParError(2,0.04920489);
   Gaussian->SetParLimits(2,0,51.09985);
