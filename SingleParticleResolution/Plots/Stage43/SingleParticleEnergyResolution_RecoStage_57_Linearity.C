...
//=========  (Tue Oct 20 18:46:11 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(3,4,3.356829405);
   graph->SetPoint(4,5,4.307416916);
   graph->SetPoint(5,6,5.2274189);
   graph->SetPoint(6,7,6.210474491);
   graph->SetPoint(7,8,7.184411049);
   graph->SetPoint(8,9,8.185114861);
   graph->SetPoint(9,10,9.089858055);
   graph->SetPoint(10,15,14.17772961);
   graph->SetPoint(11,20,19.83973694);
   graph->SetPoint(12,25,25.71344757);
   graph->SetPoint(13,30,31.1396389);
   graph->SetPoint(14,35,36.56872559);
   graph->SetPoint(15,40,41.81742859);
   graph->SetPoint(16,45,47.10624695);
   graph->SetPoint(17,50,52.83623123);
   
   TH1F *Graph_Graph43 = new TH1F("Graph_Graph43","PFO Energy vs True Energy",100,0,55);
   Graph_Graph43->SetMinimum(0);
   Graph_Graph43->SetMaximum(55);
   Graph_Graph43->SetDirectory(0);
   Graph_Graph43->SetStats(0);
   Graph_Graph43->SetLineWidth(2);
   Graph_Graph43->SetMarkerStyle(20);
   Graph_Graph43->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph43->GetXaxis()->SetRange(1,100);
   Graph_Graph43->GetXaxis()->SetNdivisions(505);
   Graph_Graph43->GetXaxis()->SetLabelFont(132);
   Graph_Graph43->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph43->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph43->GetXaxis()->SetTitleFont(132);
   Graph_Graph43->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph43->GetYaxis()->SetLabelFont(132);
   Graph_Graph43->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph43->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph43->GetYaxis()->SetTitleFont(132);
   Graph_Graph43->GetZaxis()->SetLabelFont(132);
   Graph_Graph43->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph43->GetZaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(0.3329049);
   ...
   LinearityFit->SetParameter(0,1.095272);
   LinearityFit->SetParError(0,0.005630688);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-1.937166);
   LinearityFit->SetParError(1,0.1838978);
