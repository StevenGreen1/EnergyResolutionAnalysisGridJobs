...
//=========  (Tue Oct 20 18:44:50 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-131.3813,90,1182.431);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,92);
   Name->SetBinContent(21,159);
   Name->SetBinContent(22,269);
   Name->SetBinContent(23,428);
   Name->SetBinContent(24,659);
   Name->SetBinContent(25,841);
   Name->SetBinContent(26,1001);
   Name->SetBinContent(27,944);
   Name->SetBinContent(28,809);
   Name->SetBinContent(29,550);
   Name->SetBinContent(30,378);
   Name->SetBinContent(31,188);
   Name->SetBinContent(32,91);
   Name->SetBinContent(33,38);
   ...
   Gaussian->SetChisquare(140.6834);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,943.6701);
   Gaussian->SetParError(0,15.21776);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,41.13308);
   Gaussian->SetParError(1,0.05550348);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.41041);
   Gaussian->SetParError(2,0.04554708);
   Gaussian->SetParLimits(2,0,50.4407);
