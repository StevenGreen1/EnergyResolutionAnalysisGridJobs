...
//=========  (Tue Oct 20 18:45:23 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.7803786397);
   ...
   graph->SetPoint(6,7,6.037496567);
   graph->SetPoint(7,8,7.010671139);
   graph->SetPoint(8,9,8.008551598);
   graph->SetPoint(9,10,8.917281151);
   graph->SetPoint(10,15,14.10862732);
   graph->SetPoint(11,20,19.83301544);
   graph->SetPoint(12,25,25.77398682);
   graph->SetPoint(13,30,31.20055771);
   graph->SetPoint(14,35,36.6367569);
   graph->SetPoint(15,40,41.95530319);
   graph->SetPoint(16,45,47.26794434);
   graph->SetPoint(17,50,53.1238327);
   
   TH1F *Graph_Graph31 = new TH1F("Graph_Graph31","PFO Energy vs True Energy",100,0,55);
   Graph_Graph31->SetMinimum(0);
   Graph_Graph31->SetMaximum(55);
   Graph_Graph31->SetDirectory(0);
   Graph_Graph31->SetStats(0);
   Graph_Graph31->SetLineWidth(2);
   Graph_Graph31->SetMarkerStyle(20);
   Graph_Graph31->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph31->GetXaxis()->SetRange(1,100);
   Graph_Graph31->GetXaxis()->SetNdivisions(505);
   Graph_Graph31->GetXaxis()->SetLabelFont(132);
   Graph_Graph31->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph31->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph31->GetXaxis()->SetTitleFont(132);
   Graph_Graph31->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph31->GetYaxis()->SetLabelFont(132);
   Graph_Graph31->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph31->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph31->GetYaxis()->SetTitleFont(132);
   Graph_Graph31->GetZaxis()->SetLabelFont(132);
   Graph_Graph31->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph31->GetZaxis()->SetTitleSize(0.036);
   Graph_Graph31->GetZaxis()->SetTitleFont(132);
   ...
   LinearityFit->SetChisquare(0.3561614);
   ...
   LinearityFit->SetParameter(0,1.104705);
   LinearityFit->SetParError(0,0.005824102);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-2.16145);
   LinearityFit->SetParError(1,0.1902144);
