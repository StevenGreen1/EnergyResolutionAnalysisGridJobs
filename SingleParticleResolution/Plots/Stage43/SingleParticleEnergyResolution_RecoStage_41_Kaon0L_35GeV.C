...
//=========  (Tue Oct 20 18:44:06 2015) by ROOT version5.34/30
   ...
   Name->Range(-8.750001,-109.3313,78.75,983.9813);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(131.4652);
   Gaussian->SetNDF(29);
   ...
   Gaussian->SetParameter(0,818.7136);
   Gaussian->SetParError(0,13.69688);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,37.12946);
   Gaussian->SetParError(1,0.05375356);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.220047);
   Gaussian->SetParError(2,0.0460158);
   Gaussian->SetParLimits(2,0,46.93113);
