...
//=========  (Tue Oct 20 18:44:22 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(11,20,20.26146507);
   graph->SetPoint(12,25,26.15652847);
   ...
   TH1F *Graph_Graph15 = new TH1F("Graph_Graph15","PFO Energy vs True Energy",100,0,55);
   Graph_Graph15->SetMinimum(0);
   Graph_Graph15->SetMaximum(55);
   Graph_Graph15->SetDirectory(0);
   Graph_Graph15->SetStats(0);
   Graph_Graph15->SetLineWidth(2);
   Graph_Graph15->SetMarkerStyle(20);
   Graph_Graph15->GetXaxis()->SetTitle("True Energy [GeV]");
   ...
   Graph_Graph15->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph15->GetXaxis()->SetTitleFont(132);
   Graph_Graph15->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph15->GetYaxis()->SetLabelFont(132);
   Graph_Graph15->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph15->GetYaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(0.2712681);
   ...
   LinearityFit->SetParameter(0,1.111575);
   LinearityFit->SetParError(0,0.00508287);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-1.855215);
   LinearityFit->SetParError(1,0.1660061);
