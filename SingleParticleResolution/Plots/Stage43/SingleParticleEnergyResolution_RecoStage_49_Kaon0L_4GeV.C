...
//=========  (Tue Oct 20 18:45:00 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(6,20);
   Name->SetBinContent(7,38);
   Name->SetBinContent(8,54);
   Name->SetBinContent(9,79);
   Name->SetBinContent(10,101);
   Name->SetBinContent(11,127);
   Name->SetBinContent(12,198);
   Name->SetBinContent(13,254);
   Name->SetBinContent(14,296);
   Name->SetBinContent(15,348);
   Name->SetBinContent(16,401);
   Name->SetBinContent(17,440);
   Name->SetBinContent(18,482);
   Name->SetBinContent(19,508);
   Name->SetBinContent(20,466);
   Name->SetBinContent(21,470);
   Name->SetBinContent(22,452);
   Name->SetBinContent(23,446);
   Name->SetBinContent(24,368);
   Name->SetBinContent(25,328);
   Name->SetBinContent(26,271);
   Name->SetBinContent(27,280);
   Name->SetBinContent(28,220);
   Name->SetBinContent(29,207);
   Name->SetBinContent(30,142);
   Name->SetBinContent(31,131);
   Name->SetBinContent(32,89);
   Name->SetBinContent(33,82);
   Name->SetBinContent(34,66);
   ...
   Gaussian->SetChisquare(193.1767);
   Gaussian->SetNDF(46);
   ...
   Gaussian->SetParameter(0,471.4716);
   Gaussian->SetParError(0,7.045612);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,3.230978);
   Gaussian->SetParError(1,0.01251955);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.014035);
   Gaussian->SetParError(2,0.009700671);
   Gaussian->SetParLimits(2,0,10.80529);
