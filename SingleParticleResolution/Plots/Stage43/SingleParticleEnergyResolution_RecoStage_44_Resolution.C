...
//=========  (Tue Oct 20 18:44:30 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,1.889522195);
   graph->SetPoint(1,2,0.7779803276);
   graph->SetPoint(2,3,0.4352863729);
   graph->SetPoint(3,4,0.2913000584);
   graph->SetPoint(4,5,0.2087832242);
   graph->SetPoint(5,6,0.1620016694);
   graph->SetPoint(6,7,0.1288588941);
   graph->SetPoint(7,8,0.1075630561);
   graph->SetPoint(8,9,0.09061662108);
   graph->SetPoint(9,10,0.08016210794);
   graph->SetPoint(10,15,0.04674129561);
   graph->SetPoint(11,20,0.03118938953);
   graph->SetPoint(12,25,0.02277143858);
   graph->SetPoint(13,30,0.017954221);
   graph->SetPoint(14,35,0.01462813281);
   graph->SetPoint(15,40,0.011987295);
   graph->SetPoint(16,45,0.0101690311);
   graph->SetPoint(17,50,0.008728155866);
   
   TH1F *Graph_Graph18 = new TH1F("Graph_Graph18","Energy Resolution vs Jet Energy",100,0,55);
   Graph_Graph18->SetMinimum(0);
   Graph_Graph18->SetMaximum(0.25);
   Graph_Graph18->SetDirectory(0);
   Graph_Graph18->SetStats(0);
   Graph_Graph18->SetLineWidth(2);
   Graph_Graph18->SetMarkerStyle(20);
   Graph_Graph18->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph18->GetXaxis()->SetRange(1,100);
   Graph_Graph18->GetXaxis()->SetNdivisions(505);
   Graph_Graph18->GetXaxis()->SetLabelFont(132);
   Graph_Graph18->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph18->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph18->GetXaxis()->SetTitleFont(132);
   Graph_Graph18->GetYaxis()->SetTitle("Energy Resolution  #sigma_{Reco} / E_{Reco}");
   Graph_Graph18->GetYaxis()->SetLabelFont(132);
   Graph_Graph18->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph18->GetYaxis()->SetTitleSize(0.036);
