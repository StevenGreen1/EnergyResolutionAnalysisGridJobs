...
//=========  (Tue Oct 20 18:46:07 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(140.7304);
   Gaussian->SetNDF(38);
   ...
   Gaussian->SetParameter(0,586.5806);
   Gaussian->SetParError(0,9.169533);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,9.089858);
   Gaussian->SetParError(1,0.02372735);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.792731);
   Gaussian->SetParError(2,0.01726606);
   Gaussian->SetParLimits(2,0,18.88793);
