...
//=========  (Tue Oct 20 18:45:17 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(192.1783);
   Gaussian->SetNDF(46);
   ...
   Gaussian->SetParameter(0,471.4726);
   Gaussian->SetParError(0,7.045541);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,3.230976);
   Gaussian->SetParError(1,0.0125194);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.014033);
   Gaussian->SetParError(2,0.00970036);
   Gaussian->SetParLimits(2,0,10.79706);
