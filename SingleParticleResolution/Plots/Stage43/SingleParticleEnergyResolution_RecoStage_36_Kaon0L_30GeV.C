...
//=========  (Tue Oct 20 18:43:31 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-123.2438,67.5,1109.194);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(176.1039);
   Gaussian->SetNDF(28);
   ...
   Gaussian->SetParameter(0,916.7715);
   Gaussian->SetParError(0,15.27107);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,30.57929);
   Gaussian->SetParError(1,0.04313497);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.324755);
   Gaussian->SetParError(2,0.03647792);
   Gaussian->SetParLimits(2,0,37.04797);
