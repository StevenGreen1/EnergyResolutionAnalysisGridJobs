...
//=========  (Tue Oct 20 18:45:48 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(26,302);
   Name->SetBinContent(27,254);
   Name->SetBinContent(28,237);
   Name->SetBinContent(29,197);
   Name->SetBinContent(30,166);
   ...
   Gaussian->SetChisquare(151.3041);
   Gaussian->SetNDF(45);
   ...
   Gaussian->SetParameter(0,422.5115);
   Gaussian->SetParError(0,6.462869);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,2.476129);
   Gaussian->SetParError(1,0.01019419);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.8419767);
   Gaussian->SetParError(2,0.008614297);
   Gaussian->SetParLimits(2,0,8.735739);
