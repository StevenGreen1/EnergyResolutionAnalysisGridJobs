...
//=========  (Tue Oct 20 18:43:43 2015) by ROOT version5.34/30
   ...
   Name->Range(-3.75,-103.2938,33.75,929.6438);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(17,55);
   Name->SetBinContent(18,111);
   Name->SetBinContent(19,162);
   Name->SetBinContent(20,324);
   Name->SetBinContent(21,428);
   Name->SetBinContent(22,649);
   Name->SetBinContent(23,759);
   Name->SetBinContent(24,787);
   Name->SetBinContent(25,784);
   Name->SetBinContent(26,665);
   Name->SetBinContent(27,595);
   Name->SetBinContent(28,559);
   Name->SetBinContent(29,380);
   ...
   Gaussian->SetChisquare(103.9016);
   Gaussian->SetNDF(35);
   ...
   Gaussian->SetParameter(0,775.6768);
   Gaussian->SetParError(0,11.95533);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.60255);
   Gaussian->SetParError(1,0.02602381);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.136082);
   Gaussian->SetParError(2,0.02060633);
   Gaussian->SetParLimits(2,0,22.2886);
