...
//=========  (Tue Oct 20 18:46:08 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(30,442);
   Name->SetBinContent(31,287);
   Name->SetBinContent(32,198);
   ...
   Gaussian->SetChisquare(74.69528);
   Gaussian->SetNDF(33);
   ...
   Gaussian->SetParameter(0,768.9278);
   Gaussian->SetParError(0,11.8132);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.71345);
   Gaussian->SetParError(1,0.0430926);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.570305);
   Gaussian->SetParError(2,0.03401199);
   Gaussian->SetParLimits(2,0,37.50332);
