...
//=========  (Tue Oct 20 18:44:42 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-131.5125,90,1183.613);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(22,388);
   Name->SetBinContent(23,588);
   Name->SetBinContent(24,828);
   Name->SetBinContent(25,955);
   Name->SetBinContent(26,1002);
   Name->SetBinContent(27,804);
   Name->SetBinContent(28,625);
   Name->SetBinContent(29,392);
   Name->SetBinContent(30,247);
   Name->SetBinContent(31,99);
   Name->SetBinContent(32,66);
   Name->SetBinContent(33,22);
   Name->SetBinContent(34,10);
   Name->SetBinContent(35,5);
   Name->SetBinContent(36,2);
   Name->SetBinContent(37,1);
   Name->SetBinContent(38,1);
   Name->SetBinContent(39,1);
   Name->SetEntries(6669);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(134.9896);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,933.1604);
   Gaussian->SetParError(0,15.10083);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,39.88396);
   Gaussian->SetParError(1,0.05610513);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.469447);
   Gaussian->SetParError(2,0.0466173);
   Gaussian->SetParLimits(2,0,50.17335);
