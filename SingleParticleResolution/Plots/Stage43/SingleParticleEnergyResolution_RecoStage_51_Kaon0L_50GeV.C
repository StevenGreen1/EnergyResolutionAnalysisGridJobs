...
//=========  (Tue Oct 20 18:45:22 2015) by ROOT version5.34/30
   ...
   Name->Range(-12.5,-99.09376,112.5,891.8438);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,54);
   Name->SetBinContent(21,94);
   Name->SetBinContent(22,193);
   Name->SetBinContent(23,261);
   Name->SetBinContent(24,462);
   Name->SetBinContent(25,635);
   Name->SetBinContent(26,678);
   Name->SetBinContent(27,755);
   Name->SetBinContent(28,706);
   Name->SetBinContent(29,590);
   Name->SetBinContent(30,446);
   Name->SetBinContent(31,285);
   Name->SetBinContent(32,197);
   Name->SetBinContent(33,126);
   Name->SetBinContent(34,77);
   Name->SetBinContent(35,35);
   Name->SetBinContent(36,16);
   Name->SetBinContent(37,6);
   Name->SetEntries(5744);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(101.7981);
   Gaussian->SetNDF(27);
   ...
   Gaussian->SetParameter(0,717.1903);
   Gaussian->SetParError(0,12.4158);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,53.12383);
   Gaussian->SetParError(1,0.08385406);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,6.279677);
   Gaussian->SetParError(2,0.06983981);
   Gaussian->SetParLimits(2,0,68.25833);
