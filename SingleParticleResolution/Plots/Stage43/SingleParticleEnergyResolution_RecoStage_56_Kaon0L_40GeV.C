...
//=========  (Tue Oct 20 18:46:00 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-127.3125,90,1145.813);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,89);
   Name->SetBinContent(21,153);
   Name->SetBinContent(22,243);
   Name->SetBinContent(23,400);
   Name->SetBinContent(24,609);
   Name->SetBinContent(25,883);
   Name->SetBinContent(26,970);
   Name->SetBinContent(27,929);
   Name->SetBinContent(28,785);
   ...
   Gaussian->SetChisquare(157.9734);
   Gaussian->SetNDF(31);
   ...
   Gaussian->SetParameter(0,945.8367);
   Gaussian->SetParError(0,15.24534);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,41.19489);
   Gaussian->SetParError(1,0.0554493);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.285395);
   Gaussian->SetParError(2,0.0433425);
   Gaussian->SetParLimits(2,0,49.61612);
