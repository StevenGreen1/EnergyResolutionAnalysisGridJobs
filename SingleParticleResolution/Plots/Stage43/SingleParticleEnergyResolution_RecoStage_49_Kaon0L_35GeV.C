...
//=========  (Tue Oct 20 18:45:05 2015) by ROOT version5.34/30
   ...
   Name->Range(-8.750001,-110.3813,78.75,993.4313);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(19,66);
   Name->SetBinContent(20,99);
   Name->SetBinContent(21,159);
   Name->SetBinContent(22,287);
   Name->SetBinContent(23,410);
   Name->SetBinContent(24,599);
   Name->SetBinContent(25,731);
   Name->SetBinContent(26,765);
   Name->SetBinContent(27,841);
   Name->SetBinContent(28,700);
   Name->SetBinContent(29,629);
   ...
   Gaussian->SetChisquare(101.8848);
   Gaussian->SetNDF(31);
   ...
   Gaussian->SetParameter(0,774.3901);
   Gaussian->SetParError(0,12.3905);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,36.63386);
   Gaussian->SetParError(1,0.05863482);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.760613);
   Gaussian->SetParError(2,0.04871382);
   Gaussian->SetParLimits(2,0,50.94065);
