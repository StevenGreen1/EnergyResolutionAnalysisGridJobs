...
//=========  (Tue Oct 20 18:46:10 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-115.3688,90,1038.319);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(116.1767);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,821.7324);
   Gaussian->SetParError(0,13.36005);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,41.81743);
   Gaussian->SetParError(1,0.06216149);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.965137);
   Gaussian->SetParError(2,0.05157755);
   Gaussian->SetParLimits(2,0,54.86582);
