...
//=========  (Tue Oct 20 18:45:04 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(28,648);
   Name->SetBinContent(29,526);
   Name->SetBinContent(30,446);
   Name->SetBinContent(31,326);
   ...
   Gaussian->SetChisquare(76.77179);
   Gaussian->SetNDF(35);
   ...
   Gaussian->SetParameter(0,740.21);
   Gaussian->SetParError(0,11.12595);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.77295);
   Gaussian->SetParError(1,0.04517507);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.752915);
   Gaussian->SetParError(2,0.03404855);
   Gaussian->SetParLimits(2,0,39.29741);
