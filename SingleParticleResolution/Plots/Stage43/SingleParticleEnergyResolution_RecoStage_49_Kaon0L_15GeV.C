...
//=========  (Tue Oct 20 18:45:02 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(112.8203);
   Gaussian->SetNDF(37);
   ...
   Gaussian->SetParameter(0,689.528);
   Gaussian->SetParError(0,10.42574);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.10876);
   Gaussian->SetParError(1,0.0302366);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.466527);
   Gaussian->SetParError(2,0.02311887);
   Gaussian->SetParLimits(2,0,25.49407);
