...
//=========  (Tue Oct 20 18:44:48 2015) by ROOT version5.34/30
   ...
   Name->Range(-3.75,-98.04376,33.75,882.3938);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(15,47);
   Name->SetBinContent(16,77);
   Name->SetBinContent(17,127);
   Name->SetBinContent(18,191);
   Name->SetBinContent(19,294);
   Name->SetBinContent(20,394);
   Name->SetBinContent(21,601);
   Name->SetBinContent(22,686);
   Name->SetBinContent(23,684);
   Name->SetBinContent(24,747);
   Name->SetBinContent(25,628);
   Name->SetBinContent(26,590);
   Name->SetBinContent(27,538);
   Name->SetBinContent(28,429);
   ...
   Gaussian->SetChisquare(92.52156);
   Gaussian->SetNDF(36);
   ...
   Gaussian->SetParameter(0,693.9578);
   Gaussian->SetParError(0,10.45973);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.28053);
   Gaussian->SetParError(1,0.02975715);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.455373);
   Gaussian->SetParError(2,0.02286142);
   Gaussian->SetParLimits(2,0,25.15597);
