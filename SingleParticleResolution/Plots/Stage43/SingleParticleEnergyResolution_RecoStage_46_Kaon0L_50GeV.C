...
//=========  (Tue Oct 20 18:44:43 2015) by ROOT version5.34/30
   ...
   Name->Range(-12.5,-126,112.5,1134);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(17,42);
   Name->SetBinContent(18,60);
   Name->SetBinContent(19,82);
   Name->SetBinContent(20,146);
   Name->SetBinContent(21,269);
   Name->SetBinContent(22,432);
   Name->SetBinContent(23,594);
   Name->SetBinContent(24,809);
   Name->SetBinContent(25,960);
   Name->SetBinContent(26,896);
   Name->SetBinContent(27,763);
   Name->SetBinContent(28,596);
   Name->SetBinContent(29,329);
   Name->SetBinContent(30,186);
   Name->SetBinContent(31,73);
   Name->SetBinContent(32,47);
   Name->SetBinContent(33,18);
   Name->SetBinContent(34,3);
   Name->SetBinContent(35,1);
   Name->SetBinContent(36,1);
   Name->SetEntries(6387);
   Name->SetStats(0);
   ...
   Gaussian->SetChisquare(146.0171);
   Gaussian->SetNDF(28);
   ...
   Gaussian->SetParameter(0,908.8767);
   Gaussian->SetParError(0,14.75752);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,49.39414);
   Gaussian->SetParError(1,0.07144863);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,5.478926);
   Gaussian->SetParError(2,0.05572176);
   Gaussian->SetParLimits(2,0,61.3884);
