...
//=========  (Tue Oct 20 18:45:20 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(27,593);
   Name->SetBinContent(28,558);
   Name->SetBinContent(29,436);
   Name->SetBinContent(30,341);
   ...
   Gaussian->SetChisquare(70.94144);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,706.3491);
   Gaussian->SetParError(0,10.69983);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,19.83302);
   Gaussian->SetParError(1,0.03821555);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.191056);
   Gaussian->SetParError(2,0.02993194);
   Gaussian->SetParLimits(2,0,32.93776);
