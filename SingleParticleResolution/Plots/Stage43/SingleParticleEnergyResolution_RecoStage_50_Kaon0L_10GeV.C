...
//=========  (Tue Oct 20 18:45:12 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-2.5,-76.49106,22.5,688.4195);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(204.0374);
   Gaussian->SetNDF(39);
   ...
   Gaussian->SetParameter(0,583.4057);
   Gaussian->SetParError(0,9.004242);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.915306);
   Gaussian->SetParError(1,0.02471653);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.841487);
   Gaussian->SetParError(2,0.01744589);
   Gaussian->SetParLimits(2,0,19.76976);
