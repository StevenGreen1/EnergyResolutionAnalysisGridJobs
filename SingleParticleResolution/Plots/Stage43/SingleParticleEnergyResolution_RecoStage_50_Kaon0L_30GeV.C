...
//=========  (Tue Oct 20 18:45:13 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-95.41876,67.5,858.7688);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(18,42);
   Name->SetBinContent(19,62);
   Name->SetBinContent(20,106);
   Name->SetBinContent(21,177);
   Name->SetBinContent(22,294);
   Name->SetBinContent(23,418);
   Name->SetBinContent(24,572);
   Name->SetBinContent(25,716);
   Name->SetBinContent(26,709);
   Name->SetBinContent(27,727);
   Name->SetBinContent(28,675);
   Name->SetBinContent(29,529);
   Name->SetBinContent(30,378);
   Name->SetBinContent(31,276);
   Name->SetBinContent(32,220);
   ...
   Gaussian->SetChisquare(90.93532);
   Gaussian->SetNDF(30);
   ...
   Gaussian->SetParameter(0,709.4337);
   Gaussian->SetParError(0,11.78859);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,31.20306);
   Gaussian->SetParError(1,0.05319999);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,4.171127);
   Gaussian->SetParError(2,0.04461479);
   Gaussian->SetParLimits(2,0,43.91348);
