...
//=========  (Tue Oct 20 18:45:42 2015) by ROOT version5.34/30
   ...
   Name->Range(-2.5,-81.37501,22.5,732.375);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(14,55);
   Name->SetBinContent(15,82);
   Name->SetBinContent(16,155);
   Name->SetBinContent(17,216);
   Name->SetBinContent(18,331);
   Name->SetBinContent(19,383);
   Name->SetBinContent(20,514);
   Name->SetBinContent(21,568);
   Name->SetBinContent(22,597);
   Name->SetBinContent(23,620);
   Name->SetBinContent(24,596);
   Name->SetBinContent(25,527);
   Name->SetBinContent(26,436);
   Name->SetBinContent(27,418);
   Name->SetBinContent(28,297);
   ...
   Gaussian->SetParameter(0,602.4788);
   Gaussian->SetParError(0,9.254729);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,9.138984);
   Gaussian->SetParError(1,0.02271487);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.756442);
   Gaussian->SetParError(2,0.01621819);
   Gaussian->SetParLimits(2,0,18.14925);
