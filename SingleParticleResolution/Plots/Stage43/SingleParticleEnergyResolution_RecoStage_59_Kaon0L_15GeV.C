...
//=========  (Tue Oct 20 18:46:25 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(130.8199);
   Gaussian->SetNDF(34);
   ...
   Gaussian->SetParameter(0,713.9295);
   Gaussian->SetParError(0,10.98362);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,14.17763);
   Gaussian->SetParError(1,0.02902003);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,2.348729);
   Gaussian->SetParError(2,0.02276691);
   Gaussian->SetParLimits(2,0,24.39302);
