...
//=========  (Tue Oct 20 18:46:02 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.8311607242);
   graph->SetPoint(1,2,1.604169726);
   graph->SetPoint(2,3,2.476003885);
   graph->SetPoint(3,4,3.363449574);
   graph->SetPoint(4,5,4.312588692);
   graph->SetPoint(5,6,5.23429966);
   graph->SetPoint(6,7,6.220790386);
   graph->SetPoint(7,8,7.191509247);
   graph->SetPoint(8,9,8.192442894);
   graph->SetPoint(9,10,9.103072166);
   graph->SetPoint(10,15,14.198246);
   graph->SetPoint(11,20,19.8595047);
   graph->SetPoint(12,25,25.65182495);
   graph->SetPoint(13,30,30.96395302);
   graph->SetPoint(14,35,36.18300247);
   graph->SetPoint(15,40,41.1948967);
   graph->SetPoint(16,45,46.21293259);
   graph->SetPoint(17,50,51.54237747);
   
   TH1F *Graph_Graph41 = new TH1F("Graph_Graph41","PFO Energy vs True Energy",100,0,55);
   Graph_Graph41->SetMinimum(0);
   Graph_Graph41->SetMaximum(55);
   Graph_Graph41->SetDirectory(0);
   Graph_Graph41->SetStats(0);
   Graph_Graph41->SetLineWidth(2);
   Graph_Graph41->SetMarkerStyle(20);
   Graph_Graph41->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph41->GetXaxis()->SetRange(1,100);
   Graph_Graph41->GetXaxis()->SetNdivisions(505);
   Graph_Graph41->GetXaxis()->SetLabelFont(132);
   Graph_Graph41->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph41->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph41->GetXaxis()->SetTitleFont(132);
   Graph_Graph41->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph41->GetYaxis()->SetLabelFont(132);
   Graph_Graph41->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph41->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph41->GetYaxis()->SetTitleFont(132);
   Graph_Graph41->GetZaxis()->SetLabelFont(132);
   Graph_Graph41->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph41->GetZaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(0.8013249);
   ...
   LinearityFit->SetParameter(0,1.063344);
   LinearityFit->SetParError(0,0.008735938);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-1.35479);
   LinearityFit->SetParError(1,0.2853145);
