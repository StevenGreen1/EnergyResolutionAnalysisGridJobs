...
//=========  (Tue Oct 20 18:45:01 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(247.4745);
   Gaussian->SetNDF(45);
   ...
   Gaussian->SetParameter(0,502.4049);
   Gaussian->SetParError(0,7.768259);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,5.061697);
   Gaussian->SetParError(1,0.0176811);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.346742);
   Gaussian->SetParError(2,0.01332326);
   Gaussian->SetParLimits(2,0,14.38015);
