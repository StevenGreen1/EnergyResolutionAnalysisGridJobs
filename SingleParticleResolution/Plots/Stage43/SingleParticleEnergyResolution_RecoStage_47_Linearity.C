...
//=========  (Tue Oct 20 18:44:51 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.7845141292);
   graph->SetPoint(1,2,1.539230943);
   graph->SetPoint(2,3,2.39409256);
   graph->SetPoint(3,4,3.268077135);
   graph->SetPoint(4,5,4.215982437);
   graph->SetPoint(5,6,5.125019073);
   graph->SetPoint(6,7,6.124551296);
   graph->SetPoint(7,8,7.095090866);
   graph->SetPoint(8,9,8.103926659);
   graph->SetPoint(9,10,9.020834923);
   graph->SetPoint(10,15,14.28052807);
   graph->SetPoint(11,20,19.9813633);
   graph->SetPoint(12,25,25.77285385);
   graph->SetPoint(13,30,31.06058311);
   graph->SetPoint(14,35,36.16384125);
   graph->SetPoint(15,40,41.13308334);
   graph->SetPoint(16,45,46.04257965);
   graph->SetPoint(17,50,51.228508);
   
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","PFO Energy vs True Energy",100,0,55);
   Graph_Graph23->SetMinimum(0);
   Graph_Graph23->SetMaximum(55);
   Graph_Graph23->SetDirectory(0);
   Graph_Graph23->SetStats(0);
   Graph_Graph23->SetLineWidth(2);
   Graph_Graph23->SetMarkerStyle(20);
   Graph_Graph23->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph23->GetXaxis()->SetRange(1,100);
   Graph_Graph23->GetXaxis()->SetNdivisions(505);
   Graph_Graph23->GetXaxis()->SetLabelFont(132);
   Graph_Graph23->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph23->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph23->GetXaxis()->SetTitleFont(132);
   Graph_Graph23->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph23->GetYaxis()->SetLabelFont(132);
   Graph_Graph23->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph23->GetYaxis()->SetTitleSize(0.036);
   Graph_Graph23->GetYaxis()->SetTitleFont(132);
   Graph_Graph23->GetZaxis()->SetLabelFont(132);
   Graph_Graph23->GetZaxis()->SetLabelSize(0.03);
   Graph_Graph23->GetZaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(1.285239);
   ...
   LinearityFit->SetParameter(0,1.056038);
   LinearityFit->SetParError(0,0.01106362);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-1.160664);
   LinearityFit->SetParError(1,0.3613364);
