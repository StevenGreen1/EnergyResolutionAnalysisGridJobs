...
//=========  (Tue Oct 20 18:45:13 2015) by ROOT version5.34/30
   TCanvas *Name = new TCanvas("Name", "Title",0,0,600,500);
   gStyle->SetOptStat(0);
   Name->SetHighLightColor(2);
   Name->Range(-6.25,-90.43126,56.25,813.8813);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,160);
   Name->SetBinContent(21,260);
   Name->SetBinContent(22,387);
   Name->SetBinContent(23,453);
   Name->SetBinContent(24,573);
   Name->SetBinContent(25,626);
   Name->SetBinContent(26,689);
   Name->SetBinContent(27,676);
   Name->SetBinContent(28,582);
   Name->SetBinContent(29,475);
   Name->SetBinContent(30,399);
   Name->SetBinContent(31,289);
   Name->SetBinContent(32,200);
   Name->SetBinContent(33,141);
   ...
   Gaussian->SetChisquare(67.25862);
   Gaussian->SetNDF(32);
   ...
   Gaussian->SetParameter(0,666.2145);
   Gaussian->SetParError(0,10.62469);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,25.77738);
   Gaussian->SetParError(1,0.04762232);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.745974);
   Gaussian->SetParError(2,0.03646725);
   Gaussian->SetParLimits(2,0,39.18603);
