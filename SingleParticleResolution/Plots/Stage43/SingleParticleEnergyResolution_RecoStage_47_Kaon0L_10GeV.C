...
//=========  (Tue Oct 20 18:44:48 2015) by ROOT version5.34/30
   ...
   Name->Range(-2.5,-79.01251,22.5,711.1125);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(13,48);
   Name->SetBinContent(14,86);
   Name->SetBinContent(15,130);
   Name->SetBinContent(16,210);
   Name->SetBinContent(17,275);
   Name->SetBinContent(18,356);
   Name->SetBinContent(19,449);
   Name->SetBinContent(20,535);
   Name->SetBinContent(21,569);
   Name->SetBinContent(22,555);
   Name->SetBinContent(23,556);
   Name->SetBinContent(24,602);
   ...
   Gaussian->SetParameter(0,578.0361);
   Gaussian->SetParError(0,8.839917);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,9.020835);
   Gaussian->SetParError(1,0.0245597);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.871309);
   Gaussian->SetParError(2,0.01741803);
   Gaussian->SetParLimits(2,0,19.61645);
