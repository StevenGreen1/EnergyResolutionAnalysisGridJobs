...
//=========  (Tue Oct 20 18:44:05 2015) by ROOT version5.34/30
   ...
   Name->SetBinContent(25,726);
   Name->SetBinContent(26,839);
   Name->SetBinContent(27,901);
   Name->SetBinContent(28,763);
   ...
   Gaussian->SetChisquare(99.34369);
   Gaussian->SetNDF(29);
   ...
   Gaussian->SetParameter(0,824.2822);
   Gaussian->SetParError(0,13.41841);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,31.70054);
   Gaussian->SetParError(1,0.04684629);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.764555);
   Gaussian->SetParError(2,0.03962513);
   Gaussian->SetParLimits(2,0,40.29863);
