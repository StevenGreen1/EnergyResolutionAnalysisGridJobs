...
//=========  (Tue Oct 20 18:46:14 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(220.6381);
   Gaussian->SetNDF(43);
   ...
   Gaussian->SetParameter(0,519.512);
   Gaussian->SetParError(0,8.046756);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,5.2274);
   Gaussian->SetParError(1,0.01689722);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.291688);
   Gaussian->SetParError(2,0.01275668);
   Gaussian->SetParLimits(2,0,13.88328);
