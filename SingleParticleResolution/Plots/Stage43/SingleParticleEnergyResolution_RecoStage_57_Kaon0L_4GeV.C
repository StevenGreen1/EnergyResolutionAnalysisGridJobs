...
//=========  (Tue Oct 20 18:46:05 2015) by ROOT version5.34/30
   ...
   Gaussian->SetParameter(0,479.2214);
   Gaussian->SetParError(0,7.279831);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,3.356829);
   Gaussian->SetParError(1,0.01209526);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,0.9756064);
   Gaussian->SetParError(2,0.009515339);
   Gaussian->SetParLimits(2,0,10.46556);
