...
//=========  (Tue Oct 20 18:44:29 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.7819523811);
   graph->SetPoint(1,2,1.561459899);
   graph->SetPoint(2,3,2.437687397);
   graph->SetPoint(3,4,3.340250254);
   graph->SetPoint(4,5,4.311171532);
   graph->SetPoint(5,6,5.237561226);
   graph->SetPoint(6,7,6.264039516);
   graph->SetPoint(7,8,7.24409771);
   graph->SetPoint(8,9,8.248730659);
   graph->SetPoint(9,10,9.17866993);
   graph->SetPoint(10,15,14.33902836);
   graph->SetPoint(11,20,19.70744705);
   graph->SetPoint(12,25,24.99692535);
   graph->SetPoint(13,30,29.79777527);
   graph->SetPoint(14,35,34.38694);
   graph->SetPoint(15,40,38.88917542);
   graph->SetPoint(16,45,43.26347733);
   graph->SetPoint(17,50,47.67852783);
   
   TH1F *Graph_Graph17 = new TH1F("Graph_Graph17","PFO Energy vs True Energy",100,0,55);
   Graph_Graph17->SetMinimum(0);
   Graph_Graph17->SetMaximum(55);
   Graph_Graph17->SetDirectory(0);
   Graph_Graph17->SetStats(0);
   Graph_Graph17->SetLineWidth(2);
   Graph_Graph17->SetMarkerStyle(20);
   Graph_Graph17->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph17->GetXaxis()->SetRange(1,100);
   Graph_Graph17->GetXaxis()->SetNdivisions(505);
   Graph_Graph17->GetXaxis()->SetLabelFont(132);
   Graph_Graph17->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph17->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph17->GetXaxis()->SetTitleFont(132);
   Graph_Graph17->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph17->GetYaxis()->SetLabelFont(132);
   Graph_Graph17->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph17->GetYaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(2.364009);
   ...
   LinearityFit->SetParameter(0,0.9617542);
   LinearityFit->SetParError(0,0.01500481);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,0.2849268);
   LinearityFit->SetParError(1,0.490055);
