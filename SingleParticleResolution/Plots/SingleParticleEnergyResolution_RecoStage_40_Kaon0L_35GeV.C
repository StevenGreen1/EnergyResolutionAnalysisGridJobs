...
//=========  (Fri Oct 23 09:13:19 2015) by ROOT version5.34/30
   ...
   Name->Range(-8.750001,-121.5375,78.75,1093.838);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(21,93);
   Name->SetBinContent(22,193);
   Name->SetBinContent(23,336);
   Name->SetBinContent(24,500);
   Name->SetBinContent(25,740);
   Name->SetBinContent(26,877);
   Name->SetBinContent(27,926);
   Name->SetBinContent(28,856);
   Name->SetBinContent(29,677);
   Name->SetBinContent(30,467);
   Name->SetBinContent(31,227);
   Name->SetBinContent(32,116);
   Name->SetBinContent(33,64);
   Name->SetBinContent(34,15);
   ...
   Gaussian->SetChisquare(146.3462);
   Gaussian->SetNDF(29);
   ...
   Gaussian->SetParameter(0,915.3426);
   Gaussian->SetParError(0,14.92704);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,36.69672);
   Gaussian->SetParError(1,0.04899943);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.764065);
   Gaussian->SetParError(2,0.03836414);
   Gaussian->SetParLimits(2,0,43.44049);
