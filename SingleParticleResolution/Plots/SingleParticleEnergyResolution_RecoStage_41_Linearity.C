...
//=========  (Fri Oct 23 09:13:26 2015) by ROOT version5.34/30
   ...
   graph->SetPoint(0,1,0.8610095978);
   graph->SetPoint(1,2,1.660642862);
   graph->SetPoint(2,3,2.571895361);
   graph->SetPoint(3,4,3.48636961);
   graph->SetPoint(4,5,4.459898472);
   graph->SetPoint(5,6,5.40872097);
   graph->SetPoint(6,7,6.426354408);
   graph->SetPoint(7,8,7.426832676);
   graph->SetPoint(8,9,8.458934784);
   graph->SetPoint(9,10,9.389570236);
   graph->SetPoint(10,15,14.49039555);
   graph->SetPoint(11,20,20.26073265);
   graph->SetPoint(12,25,26.15660477);
   graph->SetPoint(13,30,31.70054245);
   graph->SetPoint(14,35,37.12945938);
   graph->SetPoint(15,40,42.57541656);
   graph->SetPoint(16,45,47.94844437);
   graph->SetPoint(17,50,53.66985321);
   
   TH1F *Graph_Graph11 = new TH1F("Graph_Graph11","PFO Energy vs True Energy",100,0,55);
   Graph_Graph11->SetMinimum(0);
   Graph_Graph11->SetMaximum(55);
   Graph_Graph11->SetDirectory(0);
   Graph_Graph11->SetStats(0);
   Graph_Graph11->SetLineWidth(2);
   Graph_Graph11->SetMarkerStyle(20);
   Graph_Graph11->GetXaxis()->SetTitle("True Energy [GeV]");
   Graph_Graph11->GetXaxis()->SetRange(1,100);
   Graph_Graph11->GetXaxis()->SetNdivisions(505);
   Graph_Graph11->GetXaxis()->SetLabelFont(132);
   Graph_Graph11->GetXaxis()->SetLabelSize(0.03);
   Graph_Graph11->GetXaxis()->SetTitleSize(0.036);
   Graph_Graph11->GetXaxis()->SetTitleFont(132);
   Graph_Graph11->GetYaxis()->SetTitle("PFO Energy [GeV]");
   Graph_Graph11->GetYaxis()->SetLabelFont(132);
   Graph_Graph11->GetYaxis()->SetLabelSize(0.03);
   Graph_Graph11->GetYaxis()->SetTitleSize(0.036);
   ...
   LinearityFit->SetChisquare(0.2843702);
   ...
   LinearityFit->SetParameter(0,1.110325);
   LinearityFit->SetParError(0,0.00520418);
   LinearityFit->SetParLimits(0,0,0);
   LinearityFit->SetParameter(1,-1.829637);
   LinearityFit->SetParError(1,0.1699676);
