...
//=========  (Fri Oct 23 09:13:23 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(185.0061);
   Gaussian->SetNDF(43);
   ...
   Gaussian->SetParameter(0,551.576);
   Gaussian->SetParError(0,8.551434);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,6.426355);
   Gaussian->SetParError(1,0.01812083);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.376147);
   Gaussian->SetParError(2,0.01328787);
   Gaussian->SetParLimits(2,0,14.81215);
