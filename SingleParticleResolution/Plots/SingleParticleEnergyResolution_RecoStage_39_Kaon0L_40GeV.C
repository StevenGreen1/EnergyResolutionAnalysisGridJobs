...
//=========  (Fri Oct 23 09:13:13 2015) by ROOT version5.34/30
   ...
   Name->Range(-10,-135.0563,90,1215.506);
   Name->SetFillColor(0);
   ...
   Name->SetBinContent(20,65);
   Name->SetBinContent(21,126);
   Name->SetBinContent(22,205);
   Name->SetBinContent(23,367);
   Name->SetBinContent(24,558);
   Name->SetBinContent(25,858);
   Name->SetBinContent(26,1029);
   Name->SetBinContent(27,986);
   Name->SetBinContent(28,811);
   Name->SetBinContent(29,549);
   Name->SetBinContent(30,302);
   Name->SetBinContent(31,134);
   Name->SetBinContent(32,57);
   Name->SetBinContent(33,19);
   ...
   Gaussian->SetChisquare(180.5559);
   Gaussian->SetNDF(30);
   ...
   Gaussian->SetParameter(0,983.4649);
   Gaussian->SetParError(0,16.52712);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,41.24152);
   Gaussian->SetParError(1,0.05222192);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.932827);
   Gaussian->SetParError(2,0.04260124);
   Gaussian->SetParLimits(2,0,47.17203);
