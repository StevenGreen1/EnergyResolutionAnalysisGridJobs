...
//=========  (Fri Oct 23 09:13:29 2015) by ROOT version5.34/30
   ...
   Gaussian->SetChisquare(158.7703);
   Gaussian->SetNDF(40);
   ...
   Gaussian->SetParameter(0,581.6852);
   Gaussian->SetParError(0,9.10965);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,8.458067);
   Gaussian->SetParError(1,0.02140158);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,1.631868);
   Gaussian->SetParError(2,0.01581942);
   Gaussian->SetParLimits(2,0,17.56634);
