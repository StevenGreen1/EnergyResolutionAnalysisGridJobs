...
//=========  (Fri Oct 23 09:13:01 2015) by ROOT version5.34/30
   ...
   Name->Range(-7.500001,-133.4813,67.5,1201.331);
   Name->SetFillColor(0);
   ...
   Gaussian->SetChisquare(115.5023);
   Gaussian->SetNDF(28);
   ...
   Gaussian->SetParameter(0,950.866);
   Gaussian->SetParError(0,15.39037);
   Gaussian->SetParLimits(0,0,0);
   Gaussian->SetParameter(1,30.92972);
   Gaussian->SetParError(1,0.04079268);
   Gaussian->SetParLimits(1,0,0);
   Gaussian->SetParameter(2,3.251691);
   Gaussian->SetParError(2,0.03365973);
   Gaussian->SetParLimits(2,0,35.6712);
